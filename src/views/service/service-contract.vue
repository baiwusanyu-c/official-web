/* * @service-contract.vue * @deprecated 合约服务页面 * @author djd * @update
(czh 2022/01/05 ) */
<template>
  <div id="service_contract" class="service-page">
    ...
    <div class="page-body-search">
      <div class="body-search-text">
        <span class="font-format leading-normal">{{
          $t('lang.serviceContract.search.text')
        }}</span>
      </div>
    ...
    <div class="page-body-content">
      ...
      <div class="content-card-up">
        <div class="card">
          ...
          <img
            alt=""
            src="../../assets/img/service-contract/asset.png"
            height="120"
            width="212"
          />
        </div>
        <div class="card">
          ...
          <img
            alt=""
            src="../../assets/img/service-contract/logic.png"
            height="120"
            width="212"
          />
        </div>
      ...
      <div class="content-card-down">
        ...
        <div class="card">
          ...
          <img
            alt=""
            src="../../assets/img/service-contract/attack.png"
            height="120"
            width="212"
          />
        </div>
      ...
      <div class="page-body-reports-head">
        <div class="reports-header">
          <div class="reports-title-class">
            ...
            <div
              class="reports-title-answer font-format text-justify leading-normal"
            >
