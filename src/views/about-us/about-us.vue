  ...
  <div class="about-us-page">
    ...
    <div class="flex flex-col py-16 items-center justify-center box-border desc-info">
      <div class="flex items-center justify-between w-4/6 introduction sm:w-4/5 sm:flex-col">
        ...
        <p class="ml-16 flex-1 leading-loose text-justify text-lg sm:text-xs sm:ml-0 sm:text-justify">
      ...
      <div
        ...
        <div class="flex items-center justify-center">
          ...
          <div class="w-32 ml-2 sm:w-20">
            ...
            <span class="font-format sm:text-xs" style="word-break: break-all">{{
              $t('lang.aboutUsPage.descIconInfo4')
            }}</span>
          </div>
        </div>
      </div>
    ...
    <div
      ...
      <div class="flex items-center flex-wrap mb-20 sm:mb-6 sm:justify-between sm:px-6">
        <community-circle :index="0" @click="openWin(linkConfig['twitter'])"></community-circle>
        <community-circle :index="1" @click="openWin(linkConfig['telegram'])"></community-circle>
        <community-circle :index="2" @click="openWin(linkConfig['discord'])"></community-circle>
        ...
        <n-popover trigger="hover" color="#00FFBA" raw placement="bottom">
          ...
          <div>
            <img alt="" src="../../assets/img/wechat-code.jpg" height="100" width="100" />
          </div>
        </n-popover>
      </div>
    </div>
