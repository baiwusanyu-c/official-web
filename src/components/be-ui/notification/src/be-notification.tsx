...
export default defineComponent({
  ...
  setup(props) {
    ...
    if (
      option.placementSelf === 'topLeft' ||
      option.placementSelf === 'topRight' ||
      option.placementSelf === 'topCenter'
    ) {
     ...
     */
    const setAnimate = () => {
      const classStr = `be-${props.compType} be-${props.compType}__${option.msgType} be-${props.compType}__${option.placement} ${option.customClass}`
      containerClass.value = classStr
      if (
        option.placement === 'bottomRight' ||
