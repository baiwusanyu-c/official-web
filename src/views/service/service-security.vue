/* * @service-security.vue * @deprecated 安全服务页面 * @author czh * @update
(czh 2021/12/23) */
<template>
  <div id="service_security" class="service-page">
    ...
    <div class="page-body-search">
      <div class="body-search-text">
        <span class="leading-normal font-format">{{
          $t('lang.serviceSecurity.search.text')
        }}</span>
      </div>
    ...
    <div class="page-body-content">
      ...
      <div class="content-card-up">
        ...
        <div class="card">
          ...
          <img
            alt=""
            src="../../assets/img/block-production.png"
            height="120"
            width="212"
          />
        </div>
        <div class="card">
          ...
          <img
            alt=""
            src="../../assets/img/accounts-system.png"
            height="120"
            width="212"
          />
        </div>
        <div class="display-none sm:block">
          <div class="card">
            ...
            <img
              alt=""
              src="../../assets/img/assets-security.png"
              height="120"
              width="212"
            />
          </div>
      ...
      <div class="content-card-down">
        ...
        <div class="card">
          ...
          <img
            alt=""
            src="../../assets/img/application-layer.png"
            height="120"
            width="212"
          />
        </div>
    ...
    <div class="page-body-process-security">
      ...
      <img
        class="my-8"
        alt=""
        src="../../assets/img/process-small.png"
        height="342"
        width="1200"
      />
    </div>
    <div class="page-body-table">
      ...
      <div class="table-title-class">
        ...
        >
          ...
          <div
            v-show="tableChoseBox !== 1"
            class="table-title-chick font-format"
          >
            {{ $t('lang.serviceContract.table.titleWhite') }}
          </div>
      ...
      <div class="table-text">
        <img
          v-show="tableChoseBox === 1"
          alt=""
          src="../../assets/img/box-white.png"
        />
        <img
          v-show="tableChoseBox === 2"
          alt=""
          src="../../assets/img/box-gary.png"
        />
        <img
          v-show="tableChoseBox === 3"
          alt=""
          src="../../assets/img/box-black.png"
        />
