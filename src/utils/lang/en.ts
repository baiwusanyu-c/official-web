...
export default {
    ...
    home: {
        ...
        serviceInfo2: 'Through different security testing methods of black box, gray box and white box, we effectively verify the security of blockchain platforms through audits of core modules, node communication, storage, consensus and authority management, etc.',
    ...
    product: {
        vass: {
            ...
            funcDesc3: 'Support inter-call between multiple contracts, able to verify the properties between contracts.',
            funcSubTitle4: 'VULNERABILITY REPORT',
            funcDesc4: 'The vulnerability report presents the vulnerabilities details including types and severity and also modification suggestions.',
        ...
        eagle: {
            ...
            funcDesc1: 'Real-time monitoring transaction trends, security intelligence, suspicious transactions on the blockchain, presenting insight into specific chain.',
            ...
            funcDesc3: 'Evaluate the contract code security, transaction security, and transaction volatility to trace the security of contract lifecycle.',
            ...
            advantDesc1: 'Based on AI identification model, automatically analyzing on-chain transactions, identifying events such as flash loan attack and reentrancy exploits in time.',
