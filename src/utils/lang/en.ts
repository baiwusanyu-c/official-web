...
export default {
    ...
    home: {
        ...
        mgtitle1: 'Smart contract security audit service',
        mgtitle2: 'Blockchain platform security audit service',
        mgtitle3: 'Formal verification',
        mgtitle4: 'Blockchain situation awareness',
        ...
        serviceInfo1: 'Based on formal verification tools, we identify and eliminate security risks of the code, ensure the consistency of smart contracts’ code and business logic, and provide authoritative security audit reports.',
        ...
        serviceTitle2: 'Blockchain Platform Audit Service',
        serviceInfo2: 'Through different security testing methods of black box, gray box and white box, we effectively guarantee the security of blockchain platforms through audits of node communication, storage, consensus and authority management, maintaining the safe operation of the blockchain platform.',
        ...
        productDesc1: 'The industry-leading security analysis platform for smart contracts with multi-dimensional detection capabilities such as static scanning, fuzzy testing, and formal verification, which can automatically discover known and unknown vulnerabilities and business logic issues in smart contracts and provide professional recommendations.',
        ...
        productDesc2: 'Through real-time monitoring of on-chain transactions, identification of transaction behaviors, and detection of contract codes, it can discover hacking incidents and contract vulnerabilities, ensuring the safe operation of projects and protecting users\' virtual assets.',
        productFeature5: 'Transaction Risk Identification',
        productFeature6: 'Contract Risk Identification',
        productFeature7: 'Threat Intelligence Monitoring',
    ...
    serviceSecurity: {
        ...
        search: {
            text: 'We provide multi-dimensional security testing for codes on blockchain platforms, and effectively guarantee the overall security of blockchain platform in aspects of node communication, storage, consensus and authority management through different auditing methods, such as black box, gray box and white box testing solutions.',
    ...
    serviceContract: {
        ...
        search: {
            text: 'We provide authoritative security audit reports for smart contracts of multiple blockchain platforms based on formal verification technology. Through comprehensive verification on traditional security vulnerabilities and business logic security vulnerabilities, we ensure the consistency of the code and business logic.',
            totalCustomers: 'Total customers served',
            audited: 'Audited contracts',
            totalAudited: 'Total audited funds',
            inputTitle: 'Security Audit Report Search',
        ...
        content: {
            ...
            cardThirdParty: 'Arbitrage Attack Security Audit',
    ...
    product: {
        vass: {
            ...
            desc: 'The automatic smart contract security analysis platform provides static scanning, fuzzy testing and formal verification capabilities for smart contract codes. The platform supports 100+ testing items including traditional security vulnerabilities and business logic vulnerabilities on multiple public blockchains such as ETH, BSC, MATIC, AAVE, ONT, EOS, etc., with an accuracy rate of above 97%. It can precisely locate the risky codes while giving recommendations to help developers improve the security of smart contracts.',

            funcTitle: 'Functions',
            funcSubTitle1: 'One-click automatic detection',
            funcDesc1: 'Just upload the contract code and the platform will automatically start detection.',
            funcSubTitle2: 'Customized configuration',
            funcDesc2: 'Customized configuration for different blockchain platform parameters.',
            funcSubTitle3: 'Contract-to-contract attribute verification',
            funcDesc3: 'Support inter-call between multiple contracts, able to verify the business attribute between contracts.',
            funcSubTitle4: 'Vulnerability dashboard',
            funcDesc4: 'The vulnerability dashboard presents the types and severity levels of vulnerabilities, vulnerability details and modification suggestions',

            advantTitle: 'Our Advantages',
            advantSubTitle1: 'Rich experience in formal verification',
            advantDesc1: 'We are one of the first companies in the world to apply formal verification technology to the blockchain industry. With over 20 years of experience in formal verification technology, we have audited thousands of smart contracts.',
            advantSubTitle2: 'High-precision security testing',
            advantDesc2: '"One-click" locating the code vulnerabilities with an accuracy rate up to 97%, achieving effective verification from source code to byte code.',
            advantSubTitle3: 'Support multi-chain platforms',
            advantDesc3: 'Simultaneously support for multiple blockchain platforms (ETH, BSC, MATIC, AAVE, ONT, EOS, etc.)',
            advantSubTitle4: 'Easy formal specifications',
            advantDesc4: 'Formal specifications are written directly from the contract development language. No additional learning of language is required.',
        },
        eagle: {
            title: 'Beosin-Situation Awareness',
            subTitle: 'Provide Dapp operators with project intelligence and real-time transaction risk alerts',

            desc: 'An integrated monitoring platform designed for blockchain project owners. By automatically assessing security situation of contracts, monitoring on-chain operations and real-time transactions, it can automatically identify abnormal transactions, and comprehensively assess the operation status. With AI technology and open-source intelligence, it can help user to find out risks of smart contract, malicious transactions and potential threats of the project in real-time, get disposal suggestions and finally setup security shield for project operation and asset protection.',

            funcTitle: 'Functions',
            funcSubTitle1: 'ON-CHAIN PANORAMA',
            funcDesc1: 'Real-time monitoring of the risk transaction trends, security situation, malicious transactions on the blockchain platform , presenting a panorama of on-chain security situation.',
            funcSubTitle2: 'PROJECT SITUATION',
            funcDesc2: 'Assess the overall project security level through multiple dimensions and provide a security score for each dimension.',
            funcSubTitle3: 'CONTRACT SITUATION',
            funcDesc3: 'Evaluate the contract\'s own code security, transaction security, and transaction volatility to trace the overall security lifecycle of the contract.',
            funcSubTitle4: 'RISK WARNING',
            funcDesc4: 'Real-time risk identification of transactions on the blockchain platforms and assessment of security risks.',

            advantTitle: 'Our Advantages',
            advantSubTitle1: 'Leading security risk analysis capability',
            advantDesc1: 'Through AI risk identification model, automatically analyzing on-chain transactions in real-time, identifying risk types such as flash loan and reentrancy exploits in a timely manner.',
            advantSubTitle2: 'High automatic detection capability',
            advantDesc2: 'Relying on the self-developed smart contract formal verification engine, the contract can be automatically scanned to expose potential risks, also being rated based on security levels.',
            advantSubTitle3: 'Wide coverage of security models',
            advantDesc3: 'The four-dimensional security assessment model scores the project\'s static security, operational security, business fluctuation, and threat intelligence, and visualizes abstract security risks into intuitive and reliable scoring results, allowing users to quickly perceive risk points.',
            advantSubTitle4: 'Multiple support of blockchain platforms',
            advantDesc4: 'Covering ETH, BSC, HECO, Polygon, Tron and other mainstream blockchain platforms, synchronizing the on-chain transaction dynamics in real-time and supporting all the on-chain applications of the project parties.',
