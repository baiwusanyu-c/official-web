var e = Object.defineProperty, t = Object.getOwnPropertySymbols, a = Object.prototype.hasOwnProperty,
    ...
    o = (e, o) => {
        for (var s in o || (o = {})) a.call(o, s) && n(e, s, o[s]);
        if (t) for (var s of t(o)) l.call(o, s) && n(e, s, o[s]);
        return e
    }, s = (e, t, a) => (n(e, "symbol" != typeof t ? t + "" : t, a), a);
import {
    ...
    beforeMount(e, t) {
        ...
        const a = a => function (e, t, a) {
            const l = "function" == typeof a.value ? a.value : a.value.handler,
                n = "object" == typeof a.value && a.value.closeConditional || j;
            if (!e || !1 === n(e)) return;
            const o = ("object" == typeof a.value && a.value.include || (() => []))();
            o.push(t), !o.some((t => t.contains(e.target))) && setTimeout((() => {
                n(e) && l && l(e)
            }), 0)
        }(a, e, t);
...
var K = "top", X = "bottom", Z = "right", J = "left", Q = [K, X, Z, J], ee = Q.reduce((function (e, t) {
...
var re = {
    name: "applyStyles", enabled: !0, phase: "write", fn: function (e) {
        ...
        Object.keys(t.elements).forEach((function (e) {
            var a = t.styles[e] || {}, l = t.attributes[e] || {}, n = t.elements[e];
            se(n) && le(n) && (Object.assign(n.style, a), Object.keys(l).forEach((function (e) {
                var t = l[e];
        ...
        return Object.assign(t.elements.popper.style, a.popper), t.styles = a, t.elements.arrow && Object.assign(t.elements.arrow.style, a.arrow), function () {
            Object.keys(t.elements).forEach((function (e) {
                var l = t.elements[e], n = t.attributes[e] || {},
                    o = Object.keys(t.styles.hasOwnProperty(e) ? t.styles[e] : a[e]).reduce((function (e, t) {
                        return e[t] = "", e
                    }), {});
                se(l) && le(l) && (Object.assign(l.style, o), Object.keys(n).forEach((function (e) {
                    l.removeAttribute(e)
                })))
            }))
        }
...
function pe(e, t) {
    ...
    if (se(e) && t) {
        ...
        s > 0 && (l = a.width / s || 1), o > 0 && (n = a.height / o || 1)
    }
    return {
        width: de(a.width / l),
        height: de(a.height / n),
        top: de(a.top / n),
        right: de(a.right / l),
        bottom: de(a.bottom / n),
        left: de(a.left / l),
        x: de(a.left / l),
        y: de(a.top / n)
    }
...
function ue(e) {
    var t = pe(e), a = e.offsetWidth, l = e.offsetHeight;
...
function ge(e) {
    return "html" === le(e) ? e : e.assignedSlot || e.parentNode || (ie(e) ? e.host : null) || we(e)
}

function fe(e) {
    return se(e) && "fixed" !== ve(e).position ? e.offsetParent : null
}

function ye(e) {
    for (var t = ne(e), a = fe(e); a && he(a) && "static" === ve(a).position;) a = fe(a);
    return a && ("html" === le(a) || "body" === le(a) && "static" === ve(a).position) ? t : a || function (e) {
        var t = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
        if (-1 !== navigator.userAgent.indexOf("Trident") && se(e) && "fixed" === ve(e).position) return null;
        for (var a = ge(e); se(a) && ["html", "body"].indexOf(le(a)) < 0;) {
            var l = ve(a);
...
var be = Math.max, Ce = Math.min, De = Math.round;
...
function Te(e) {
    var t, a = e.popper, l = e.popperRect, n = e.placement, o = e.variation, s = e.offsets, i = e.position,
        r = e.gpuAcceleration, c = e.adaptive, d = e.roundOffsets, p = !0 === d ? function (e) {
            var t = e.x, a = e.y, l = window.devicePixelRatio || 1;
            return {x: De(De(t * l) / l) || 0, y: De(De(a * l) / l) || 0}
        }(s) : "function" == typeof d ? d(s) : s, u = p.x, m = void 0 === u ? 0 : u, v = p.y, h = void 0 === v ? 0 : v,
        w = s.hasOwnProperty("x"), g = s.hasOwnProperty("y"), f = J, y = K, x = window;
    if (c) {
        var b = ye(a), C = "clientHeight", D = "clientWidth";
        b === ne(a) && "static" !== ve(b = we(a)).position && "absolute" === i && (C = "scrollHeight", D = "scrollWidth"), b = b, n !== K && (n !== J && n !== Z || "end" !== o) || (y = X, h -= b[C] - l.height, h *= r ? 1 : -1), n !== J && (n !== K && n !== X || "end" !== o) || (f = Z, m -= b[D] - l.width, m *= r ? 1 : -1)
    }
    var L, V = Object.assign({position: i}, c && Be);
    return r ? Object.assign({}, V, ((L = {})[y] = g ? "0" : "", L[f] = w ? "0" : "", L.transform = (x.devicePixelRatio || 1) <= 1 ? "translate(" + m + "px, " + h + "px)" : "translate3d(" + m + "px, " + h + "px, 0)", L)) : Object.assign({}, V, ((t = {})[y] = g ? h + "px" : "", t[f] = w ? m + "px" : "", t.transform = "", t))
}
...
function Ne(e) {
    return pe(we(e)).left + Ie(e).scrollLeft
}

function He(e) {
    var t = ve(e), a = t.overflow, l = t.overflowX, n = t.overflowY;
    return /auto|scroll|overlay|hidden/.test(a + n + l)
}

function _e(e) {
    return ["html", "body", "#document"].indexOf(le(e)) >= 0 ? e.ownerDocument.body : se(e) && He(e) ? e : _e(ge(e))
}

function Oe(e, t) {
    var a;
    void 0 === t && (t = []);
    var l = _e(e), n = l === (null == (a = e.ownerDocument) ? void 0 : a.body), o = ne(l),
        s = n ? [o].concat(o.visualViewport || [], He(l) ? l : []) : l, i = t.concat(s);
    return n ? i : i.concat(Oe(ge(s)))
}
...
function Ae(e, t) {
    return "viewport" === t ? $e(function (e) {
        var t = ne(e), a = we(e), l = t.visualViewport, n = a.clientWidth, o = a.clientHeight, s = 0, i = 0;
        return l && (n = l.width, o = l.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (s = l.offsetLeft, i = l.offsetTop)), {
            width: n,
            height: o,
            x: s + Ne(e),
            y: i
        ...
        var t, a = we(e), l = Ie(e), n = null == (t = e.ownerDocument) ? void 0 : t.body,
            o = be(a.scrollWidth, a.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0),
            s = be(a.scrollHeight, a.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0),
            i = -l.scrollLeft + Ne(e), r = -l.scrollTop;
        return "rtl" === ve(n || a).direction && (i += be(a.clientWidth, n ? n.clientWidth : 0) - o), {
            width: o,
            height: s,
            x: i,
            y: r
...
function We(e, t, a) {
    var l = "clippingParents" === t ? function (e) {
        var t = Oe(ge(e)), a = ["absolute", "fixed"].indexOf(ve(e).position) >= 0 && se(e) ? ye(e) : e;
        return oe(a) ? t.filter((function (e) {
            return oe(e) && me(e, a) && "body" !== le(e)
        })) : []
    }(e) : [].concat(t), n = [].concat(l, [a]), o = n[0], s = n.reduce((function (t, a) {
        var l = Ae(e, a);
        return t.top = be(l.top, t.top), t.right = Ce(l.right, t.right), t.bottom = Ce(l.bottom, t.bottom), t.left = be(l.left, t.left), t
    }), Ae(e, o));
    return s.width = s.right - s.left, s.height = s.bottom - s.top, s.x = s.left, s.y = s.top, s
}

function Ue(e) {
    var t, a = e.reference, l = e.element, n = e.placement, o = n ? ce(n) : null, s = n ? Se(n) : null,
...
function Fe(e, t) {
    void 0 === t && (t = {});
    var a = t, l = a.placement, n = void 0 === l ? e.placement : l, o = a.boundary,
        s = void 0 === o ? "clippingParents" : o, i = a.rootBoundary, r = void 0 === i ? "viewport" : i,
        c = a.elementContext, d = void 0 === c ? "popper" : c, p = a.altBoundary, u = void 0 !== p && p, m = a.padding,
        v = void 0 === m ? 0 : m, h = Ve("number" != typeof v ? v : ke(v, Q)),
        w = "popper" === d ? "reference" : "popper", g = e.rects.popper, f = e.elements[u ? w : d],
        y = We(oe(f) ? f : f.contextElement || we(e.elements.popper), s, r), x = pe(e.elements.reference),
        b = Ue({reference: x, element: g, strategy: "absolute", placement: n}), C = $e(Object.assign({}, g, b)),
        D = "popper" === d ? C : x, L = {
            top: y.top - D.top + h.top,
            bottom: D.bottom - y.bottom + h.bottom,
            left: y.left - D.left + h.left,
            right: D.right - y.right + h.right
        }, V = e.modifiersData.offset;
    if ("popper" === d && V) {
        var k = V[n];
        Object.keys(L).forEach((function (e) {
            var t = [Z, X].indexOf(e) >= 0 ? 1 : -1, a = [K, X].indexOf(e) >= 0 ? "y" : "x";
            L[e] += k[a] * t
        }))
    }
    return L
...
function je(e, t, a) {
    void 0 === a && (a = !1);
    var l, n, o = se(t), s = se(t) && function (e) {
        var t = e.getBoundingClientRect(), a = t.width / e.offsetWidth || 1, l = t.height / e.offsetHeight || 1;
        return 1 !== a || 1 !== l
    }(t), i = we(t), r = pe(e, s), c = {scrollLeft: 0, scrollTop: 0}, d = {x: 0, y: 0};
    return (o || !o && !a) && (("body" !== le(t) || He(i)) && (c = (l = t) !== ne(l) && se(l) ? {
        scrollLeft: (n = l).scrollLeft,
        scrollTop: n.scrollTop
    } : Ie(l)), se(t) ? ((d = pe(t, !0)).x += t.clientLeft, d.y += t.clientTop) : i && (d.x = Ne(i))), {
...
function Ze(e) {
    void 0 === e && (e = {});
    var t = e, a = t.defaultModifiers, l = void 0 === a ? [] : a, n = t.defaultOptions, o = void 0 === n ? Ke : n;
    return function (e, t, a) {
        ...
        var n, s, i = {
            ...
            state: i, setOptions: function (a) {
                var n = "function" == typeof a ? a(i.options) : a;
                p(), i.options = Object.assign({}, o, i.options, n), i.scrollParents = {
                    reference: oe(e) ? Oe(e) : e.contextElement ? Oe(e.contextElement) : [],
                    popper: Oe(t)
                };
                ...
                return i.orderedModifiers = u.filter((function (e) {
                    ...
                    var t = e.name, a = e.options, l = void 0 === a ? {} : a, n = e.effect;
                    if ("function" == typeof n) {
                        var o = n({state: i, name: t, instance: d, options: l}), s = function () {
                        };
                        r.push(o || s)
                    }
                })), d.update()
                ...
                if (!c) {
                    ...
                    if (Xe(t, a)) {
                        i.rects = {
                            reference: je(t, ye(a), "fixed" === i.options.strategy),
                            popper: ue(a)
                        }, i.reset = !1, i.placement = i.options.placement, i.orderedModifiers.forEach((function (e) {
                            return i.modifiersData[e.name] = Object.assign({}, e.data)
                        }));
                        for (var l = 0; l < i.orderedModifiers.length; l++) if (!0 !== i.reset) {
                            var n = i.orderedModifiers[l], o = n.fn, s = n.options, r = void 0 === s ? {} : s,
                                p = n.name;
                            "function" == typeof o && (i = o({state: i, options: r, name: p, instance: d}) || i)
                        } else i.reset = !1, l = -1
                    }
                }
            }, update: (n = function () {
...
var Je = Ze({
    defaultModifiers: [{
        name: "eventListeners", enabled: !0, phase: "write", fn: function () {
            ...
            var t = e.state, a = e.instance, l = e.options, n = l.scroll, o = void 0 === n || n, s = l.resize,
                i = void 0 === s || s, r = ne(t.elements.popper),
        ...
        name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: function (e) {
            var t = e.state, a = e.options, l = a.gpuAcceleration, n = void 0 === l || l, o = a.adaptive,
                s = void 0 === o || o, i = a.roundOffsets, r = void 0 === i || i, c = {
        ...
        name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: function (e) {
            var t = e.state, a = e.options, l = e.name, n = a.offset, o = void 0 === n ? [0, 0] : n,
                s = te.reduce((function (e, a) {
                    return e[a] = function (e, t, a) {
                        var l = ce(e), n = [J, K].indexOf(l) >= 0 ? -1 : 1,
                            o = "function" == typeof a ? a(Object.assign({}, t, {placement: e})) : a, s = o[0],
                            i = o[1];
                        return s = s || 0, i = (i || 0) * n, [J, Z].indexOf(l) >= 0 ? {x: i, y: s} : {x: s, y: i}
                    }(a, t.rects, o), e
        ...
        name: "flip", enabled: !0, phase: "main", fn: function (e) {
            ...
            if (!t.modifiersData[l]._skip) {
                for (var n = a.mainAxis, o = void 0 === n || n, s = a.altAxis, i = void 0 === s || s, r = a.fallbackPlacements, c = a.padding, d = a.boundary, p = a.rootBoundary, u = a.altBoundary, m = a.flipVariations, v = void 0 === m || m, h = a.allowedAutoPlacements, w = t.options.placement, g = ce(w), f = r || (g === w || !v ? [Ee(w)] : function (e) {
                    if ("auto" === ce(e)) return [];
                    var t = Ee(e);
                    return [Ge(e), t, Ge(t)]
                }(w)), y = [w].concat(f).reduce((function (e, a) {
                    return e.concat("auto" === ce(a) ? function (e, t) {
                        void 0 === t && (t = {});
                        var a = t, l = a.placement, n = a.boundary, o = a.rootBoundary, s = a.padding,
                            i = a.flipVariations, r = a.allowedAutoPlacements, c = void 0 === r ? te : r, d = Se(l),
                            p = d ? i ? ee : ee.filter((function (e) {
                                return Se(e) === d
                            })) : Q, u = p.filter((function (e) {
                                return c.indexOf(e) >= 0
                            }));
                        0 === u.length && (u = p);
                        var m = u.reduce((function (t, a) {
                            return t[a] = Fe(e, {placement: a, boundary: n, rootBoundary: o, padding: s})[ce(a)], t
                        }), {});
                ...
                }), []), x = t.rects.reference, b = t.rects.popper, C = new Map, D = !0, L = y[0], V = 0; V < y.length; V++) {
                    var k = y[V], S = ce(k), B = "start" === Se(k), T = [K, X].indexOf(S) >= 0,
                        z = T ? "width" : "height",
                        P = Fe(t, {placement: k, boundary: d, rootBoundary: p, altBoundary: u, padding: c}),
                        E = T ? B ? Z : J : B ? X : K;
                    x[z] > b[z] && (E = Ee(E));
                    var M = Ee(E), G = [];
                    if (o && G.push(P[S] <= 0), i && G.push(P[E] <= 0, P[M] <= 0), G.every((function (e) {
                        return e
                    }))) {
                        L = k, D = !1;
                        break
        ...
        name: "preventOverflow", enabled: !0, phase: "main", fn: function (e) {
            var t = e.state, a = e.options, l = e.name, n = a.mainAxis, o = void 0 === n || n, s = a.altAxis,
                i = void 0 !== s && s, r = a.boundary, c = a.rootBoundary, d = a.altBoundary, p = a.padding,
                u = a.tether, m = void 0 === u || u, v = a.tetherOffset, h = void 0 === v ? 0 : v,
                w = Fe(t, {boundary: r, rootBoundary: c, padding: p, altBoundary: d}), g = ce(t.placement),
                f = Se(t.placement), y = !f, x = xe(g), b = "x" === x ? "y" : "x", C = t.modifiersData.popperOffsets,
                D = t.rects.reference, L = t.rects.popper,
                V = "function" == typeof h ? h(Object.assign({}, t.rects, {placement: t.placement})) : h,
                k = {x: 0, y: 0};
            if (C) {
                if (o || i) {
                    var S = "y" === x ? K : J, B = "y" === x ? X : Z, T = "y" === x ? "height" : "width", z = C[x],
                        P = C[x] + w[S], E = C[x] - w[B], M = m ? -L[T] / 2 : 0, G = "start" === f ? D[T] : L[T],
                        I = "start" === f ? -L[T] : -D[T], N = t.elements.arrow,
                        H = m && N ? ue(N) : {width: 0, height: 0},
                        _ = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : {
                            top: 0,
                            right: 0,
                            bottom: 0,
                            left: 0
                        }, O = _[S], $ = _[B], A = Le(0, D[T], H[T]), W = y ? D[T] / 2 - M - A - O - V : G - A - O - V,
                        U = y ? -D[T] / 2 + M + A + $ + V : I + A + $ + V, F = t.elements.arrow && ye(t.elements.arrow),
                        Y = F ? "y" === x ? F.clientTop || 0 : F.clientLeft || 0 : 0,
                        R = t.modifiersData.offset ? t.modifiersData.offset[t.placement][x] : 0, j = C[x] + W - R - Y,
                        q = C[x] + U - R;
                    if (o) {
                        var Q = Le(m ? Ce(P, j) : P, z, m ? be(E, q) : E);
                        C[x] = Q, k[x] = Q - z
                    }
                    if (i) {
                        var ee = "x" === x ? K : J, te = "x" === x ? X : Z, ae = C[b], le = ae + w[ee], ne = ae - w[te],
                            oe = Le(m ? Ce(le, j) : le, ae, m ? be(ne, q) : ne);
                        C[b] = oe, k[b] = oe - ae
                    }
                }
                t.modifiersData[l] = k
        ...
        name: "arrow", enabled: !0, phase: "main", fn: function (e) {
            var t, a = e.state, l = e.name, n = e.options, o = a.elements.arrow, s = a.modifiersData.popperOffsets,
                i = ce(a.placement), r = xe(i), c = [J, Z].indexOf(i) >= 0 ? "height" : "width";
            if (o && s) {
                var d = function (e, t) {
                        return Ve("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, t.rects, {placement: t.placement})) : e) ? e : ke(e, Q))
                    }(n.padding, a), p = ue(o), u = "y" === r ? K : J, m = "y" === r ? X : Z,
                    v = a.rects.reference[c] + a.rects.reference[r] - s[r] - a.rects.popper[c],
                    h = s[r] - a.rects.reference[r], w = ye(o),
                    g = w ? "y" === r ? w.clientHeight || 0 : w.clientWidth || 0 : 0, f = v / 2 - h / 2, y = d[u],
                    x = g - p[c] - d[m], b = g / 2 - p[c] / 2 + f, C = Le(y, b, x), D = r;
                a.modifiersData[l] = ((t = {})[D] = C, t.centerOffset = C - b, t)
            }
        }, effect: function (e) {
            var t = e.state, a = e.options.element, l = void 0 === a ? "[data-popper-arrow]" : a;
            null != l && ("string" != typeof l || (l = t.elements.popper.querySelector(l))) && me(t.elements.popper, l) && (t.elements.arrow = l)
        }, requires: ["popperOffsets"], requiresIfExists: ["preventOverflow"]
    }, {
        name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: function (e) {
            var t = e.state, a = e.name, l = t.rects.reference, n = t.rects.popper, o = t.modifiersData.preventOverflow,
                s = Fe(t, {elementContext: "reference"}), i = Fe(t, {altBoundary: !0}), r = Ye(s, l), c = Ye(i, n, o),
                d = Re(r), p = Re(c);
            t.modifiersData[a] = {
...
const Qe = e => null !== e && "object" == typeof e, et = () => {
    let e = [], t = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
const tt = e => !!/^(([1-9][0-9]*\.[0-9][0-9]*)|([0]\.[0-9][0-9]*)|([1-9][0-9]*)|([0]{1}))$/.test(e),
    at = e => JSON.parse(JSON.stringify(e)), lt = e => "boolean" == typeof e,
    nt = e => "string" == typeof e && e.constructor == String, ot = e => "number" == typeof e,
    st = e => "[object Function]" === Object.prototype.toString.call(e);
var it = i({
    name: "BePopover",
    ...
    setup(e, t) {
        ...
        const n = a => {
            let n = 0;
            const o = "manual" === a ? !l.value : a;
            n = o ? e.delay : e.duration, setTimeout((() => {
                l.value = o, v((() => {
                    l.value && i(e.placement), t.emit("update", l.value)
                }))
            }), n)
        };
        let o = d({left: "0px", top: "0px"}), s = null;
        const i = (t, l = "") => {
            if ("update" === l) return void s.update();
            s && s.destroy && s.destroy();
            const n = document.getElementById(`be_popover_${a.uid}`);
            let o = {
                placement: t,
                modifiers: [{
                    name: "arrow",
            ...
            if (e.x && e.y) {
                let t = {getBoundingClientRect: w()};
                s = Je(t, n, o), t.getBoundingClientRect = w(e.x, e.y), s.update()
            } else s = Je(f, n, o)
        }, w = (e = 0, t = 0) => {
        ...
        const y = e => {
            ...
            click: n.bind(this, !0),
            mouseenter: n.bind(this, !0),
            mouseleave: n.bind(this, !1),
            manual: n.bind(this, "manual")
        }, b = l => {
            if (t.slots.trigger) {
                const t = l || e.triggerElm;
                t ? (g = nt(t) ? document.getElementById(t) : t, f = y(a.refs.bePopoverTrigger) || g || a.refs.bePopoverTrigger) : (g = y(a.refs.bePopoverTrigger) || a.refs.bePopoverTrigger, f = g || a.refs.bePopoverTrigger), g && "click" === e.trigger && g.addEventListener("click", x.click, !1), g && "hover" === e.trigger && (g.addEventListener("mouseenter", x.mouseenter, !1), g.addEventListener("mouseleave", x.mouseleave, !1)), g && "manual" === e.trigger && g.addEventListener("click", x.manual, !1)
        ...
        const D = () => {
            g && (g.removeEventListener("click", x.click, !1), g.removeEventListener("mouseenter", x.mouseenter, !1), g.removeEventListener("mouseleave", x.mouseleave, !1), g.removeEventListener("mouseleave", x.manual, !1))
        };
        let L = c(!1);
        return m((() => {
            "hover" !== e.trigger && "manual" !== e.trigger || (L.value = !0), e.disabled || (e.width && (o.width = e.width + "px"), v((() => {
                b()
            })))
        })), h((() => {
            D(), s && s.destroy && s.destroy()
        })), {
            uid: a.uid, addEvent: b, stylePopover: o, outsideDisabled: L, show: l, close: () => {
                setTimeout((() => {
                    l.value = !1, t.emit("update", l.value)
                }), e.duration)
            }, changeDisplay: n, computePosition: i, raw: e.raw, customClass: e.customClass
        }
    }
});
const rt = ["id"], ct = ["id"], dt = ["id"], pt = ["id"];
it.render = function (e, t, a, l, n, o) {
    const s = w("click-outside");
    return g(), f(y, null, [x("div", {
        id: `be_popover_trigger${e.uid}`,
        "aria-describedby": "tooltip",
        ref: "bePopoverTrigger"
    }, [b(e.$slots, "trigger")], 8, rt), (g(), C(D, {to: "body"}, [x("div", {class: L(e.customClass)}, [V(k, {name: "be-fade-in-linear"}, {
        default: S((() => [e.show ? B((g(), f("div", {
            class: "be-popover",
            role: "tooltip",
        ...
        }, [b(e.$slots, "default")], 8, dt), e.raw ? (g(), f("div", {
            key: 0,
            id: `be_popover_arrow${e.uid}`,
            class: L("be-popover-arrow")
        }, null, 8, pt)) : z("", !0)], 12, ct)), [[s, {
            handler: e.close,
...
ut.render = function (e, t, a, l, n, o) {
    const s = P("be-popover");
    return g(), C(s, {
        ...
        trigger: S((() => [b(e.$slots, "default")])),
        default: S((() => [x("span", null, E(e.content), 1)])),
        _: 3
    }, 8, ["placement", "raw", "customClass", "disabled", "delay", "duration", "x", "y", "width", "trigger"])
};
var mt = i({
    name: "BeEllipsis",
    components: {"be-tooltip": ut},
    props: {
        content: {type: String, default: ""},
    ...
    setup(e) {
        const t = r(), a = d({isExpand: !1, textCache: "", textInner: e.text}), l = () => {
            if (0 !== e.elpNum) {
                if ("left" === e.placement && (a.textInner = e.text.slice(0, e.text.length - e.elpNum) + "..."), "center" === e.placement) {
                    let t = e.elpNum / 2, l = e.text.length / 2, n = e.text.substr(0, l - t),
                        o = e.text.substr(l + t, e.text.length);
                    a.textInner = n + "..." + o
                }
        ...
        return {
            state: a, styleStr: n, handleText: l, expandTriggerFunc: () => {
                e.expandTrigger && (a.isExpand = !a.isExpand, n.value = a.isExpand ? "" : `\n      -webkit-line-clamp:${e.lineClamp};\n      display:-webkit-inline-box;\n      -webkit-box-orient:vertical;\n      overflow:hidden;`, a.isExpand && (a.textInner = a.textCache), !a.isExpand && l())
            }, attrs: t.attrs
        }
    }
});
const vt = ["innerHTML"];
mt.render = function (e, t, a, l, n, o) {
    const s = P("be-tooltip");
    return g(), C(s, {
        content: e.content,
        placement: "top"
    }, {
        default: S((() => [x("span", G(e.attrs, {
...
var wt = i({
    ...
    setup(e, t) {
        const a = p((() => `${e.icon}`)), l = p((() => e.spin ? "be-icon-spin " + e.customClass : "" + e.customClass));
        return {props: e, iconName: a, spinClass: l}
    }
});
const gt = ["width", "height"], ft = ["xlink:href", "fill"];
wt.render = function (e, t, a, l, n, o) {
    return g(), f("div", G({class: ["be-icon-container", e.spinClass]}, I(e.$attrs)), [(g(), f("svg", {
        class: "be-icon",
        width: e.width,
        height: e.height,
        "aria-hidden": "true"
    }, [x("use", {"xlink:href": `#${e.iconName}`, fill: e.color}, null, 8, ft)], 8, gt))], 16)
};
const yt = e => ({
    name: "BeCustomIcon", props: {spin: {type: Boolean, default: !1}}, setup(e) {
        const t = e.customClass ? e.customClass : "";
        return {spinClass: p((() => e.spin ? "be-icon-spin " + t : "" + t))}
    }, render() {
        return N(V("div", G({class: `be-icon-container ${this.spinClass}`}, this.$attrs), [e]))
    }
});
var xt = {
...
class bt {
    ...
    loadIconXML(e) {
        this.isAllLoad || (this.svgElm.innerHTML = this.svgElm.innerHTML + xt[e], this.appendToBody())
    }

    loadAllIconXML() {
        Object.keys(xt).forEach((e => {
            this.svgElm.innerHTML = this.svgElm.innerHTML + xt[e]
        })), this.appendToBody()
    }
...
const Dt = new Set;
Ct.createFromIconfontCN = e => {
    if ("undefined" != typeof document && "undefined" != typeof window && "function" == typeof document.createElement && "string" == typeof e && e.length && !Dt.has(e)) {
        const t = document.createElement("script");
        t.setAttribute("src", e), t.setAttribute("data-namespace", e), Dt.add(e), document.body.appendChild(t)
    }
};
const Lt = Ct.BeIconComponets, Vt = Ct.createFromIconfontCN;
var kt = Object.freeze({
    __proto__: null,
    [Symbol.toStringTag]: "Module",
    default: Ct,
    BeIconComponets: Lt,
    createFromIconfontCN: Vt
});
it.install = e => {
...
var Tt = i({
    ...
    setup(e, t) {
        ...
        return () => V("button", G({type: "button"}, t.attrs, {
            style: n.value,
            id: `be_button_${l.value}`,
            class: `\n                    be-button \n                    be-button__inner ${s.value} \n                    be-button__${e.size} \n                    be-button__${e.type}${o.value} \n                    ${e.customClass}`,
            disabled: e.disabled || e.loading
        }), [V("div", {
            class: "be-button-body",
            style: "margin: 0 auto;display: flex"
        }, [e.prevIcon || e.loading ? V(P("be-icon"), {
            icon: i.value,
            spin: e.loading,
            "custom-class": `be-button-prevIcon be-button-prevIcon__${e.type}`
        }, null) : "", V("div", {class: "be-button-slot"}, [t.slots.default && t.slots.default()]), e.nextIcon ? V(P("be-icon"), {
            icon: d.value,
...
const Pt = zt, Et = {
    beforeMount(e, t) {
        ...
        let l = null;
        const n = a.children;
        for (let o = 0; o < n.length; o++) if (n[o].className && n[o].className.indexOf("info-tag") > -1) {
            l = n[o];
            break
        }
        e.onmousedown = e => {
            let n = !1;
            const o = e;
            if (o.path) for (let t = 0; t < o.path.length; t++) {
                if (a.firstChild === o.path[t] || l === o.path[t]) {
                    n = !0;
                    break
                }
                if (a.firstChild === o.path[t]) {
                    n = !1;
                    break
                }
            } else n = !0;
            if (!n) return;
            let s = document.body.offsetWidth, i = document.body.offsetHeight;
            if (0 === s || 0 === i) return void console.error("Please set the width and height of the body element");
            let r = e.clientX - a.offsetLeft, c = e.clientY - a.offsetTop;
            const d = e.currentTarget;
            let p = d.offsetWidth, u = d.offsetHeight, m = 0;
            document.onmousemove = e => {
                if (m > 1) {
                    let l = e.clientX - r, n = e.clientY - c, o = s - p, d = i - u;
                    n < 0 && (n = 0), l < 0 && (l = 0), n > d && (n = d), l > o && (l = o), a.style.left = l + "px", a.style.top = n + "px", a.style.transform = "translate(0%, 0%)", t.value && "[object Function]" === Object.prototype.toString.call(t.value) && t.value({
                        left: l,
                        top: n
                    })
                }
...
var Mt = i({
    name: "BeDialog",
    components: {BeIcon: wt, BeButton: Tt},
    directives: {drag: Et},
    emits: ["confirm", "close", "update:isShow", "escEvt"],
    props: {
        isDrag: {type: Boolean, default: !0},
    ...
    setup(e, t) {
        const a = p((() => e.customClass)), l = r(), n = e => {
        ...
        const s = () => {
            e.escExit && (document.body.onkeydown = e => {
                e && "Escape" === e.key && (t.emit("escEvt"), n("keyboard"))
            })
        }, i = () => {
        ...
        return m((() => {
            ...
            dialogModels: d, customClassStyle: a, handleClose: n, handleConfirm: () => {
                t.emit("confirm"), n()
            }, uid: l.uid
        }
    }
});
const Gt = {key: 0, class: "be-dialog"}, It = ["id"], Nt = {class: "be-dialog-title"}, Ht = ["id"],
    _t = {class: "be-dialog-close"}, Ot = {class: "be-dialog-body"}, $t = {class: "be-dialog-body__inner"},
    At = _("确定 ");
Mt.render = function (e, t, a, l, n, o) {
    const s = P("be-icon"), i = P("be-button"), r = w("drag");
    return g(), f(y, null, [e.isShow ? (g(), f("div", {
        key: 0,
        class: L(e.dialogModels)
    }, null, 2)) : z("", !0), V(k, {name: "dialog-fade"}, {
        default: S((() => [e.isShow ? (g(), f("div", Gt, [B(x("div", {
            class: L(["be-dialog-container", e.customClassStyle]),
            id: `be_dialog_container${e.uid}`
        }, [x("div", Nt, [x("div", {
            class: "be-dialog-container-head",
            id: `be_head${e.uid}`
        }, [x("span", null, E(e.titles), 1), x("div", _t, [b(e.$slots, "headerIcon", {}, (() => [V(s, {
            icon: "deleteIc",
            "custom-class": "be-dialog-close-btn",
            onClick: t[0] || (t[0] = t => e.handleClose("btn"))
        })]))])], 8, Ht)]), x("div", Ot, [x("div", $t, [b(e.$slots, "body")])]), x("div", {class: L(`be-dialog-footer be-dialog-footer__${e.layout}`)}, [b(e.$slots, "footer", {}, (() => [V(i, {
            type: "primary",
            bordered: "",
            round: "3",
            ...
            default: S((() => [At])),
            _: 1
        }, 8, ["onClick"])]))], 2)], 10, It), [[r, {isDrag: e.isDrag}]])])) : z("", !0)])), _: 3
    })], 64)
}, Mt.install = e => {
    e.component(Mt.name, Mt)
};
...
var Ut = i({
    name: "BeLoadingAnimate", inject: ["$$BeLoading"], render() {
        const e = [];
        if (this.$$BeLoading.customRender()) e[0] = this.$$BeLoading.customRender(); else for (let a = 0; a <= 2; a++) e.push((t = this.$$BeLoading.color, V("div", {class: "circleBox"}, [V("span", {style: `background-color:${t}`}, null), V("span", {style: `background-color:${t}`}, null), V("span", {style: `background-color:${t}`}, null), V("span", {style: `background-color:${t}`}, null)])));
        var t;
        return V("div", {
    ...
    name: "BeLoading",
    components: {BeLoadingAnimate: Ut},
    provide() {
    ...
    props: {
        ...
        bgColor: {type: String, default: "rgba(255,255,255,.5)"},
        customRender: {type: Function, default: () => null}
    },
    setup(e) {
        const t = c("50%"), a = c("50%"), l = c(""), n = c(""), o = c(null), s = p((() => e.size)), i = c(""),
            d = c(""), m = c("50%"), h = c("50%"), w = p((() => e.isBackground ? "be-loader__bg" : "")),
            g = p((() => e.isFullScreen ? "be-load-container__fullScreen" : "")), f = c(""), y = c(""), x = e => {
                e && v((() => {
                    let l = L(e);
                    l && (t.value = l.width / 2 + "px", a.value = l.height / 2 + "px", f.value = l.width + "px", y.value = l.height + "px"), D()
                }))
            }, b = c(""), C = c(""), D = () => {
                e.text && v((() => {
                    ...
                    b.value = t.value;
                    let n = null;
                    a.value.split("px").length > 1 ? (n = a.value.split("px"), C.value = Number(n[0]) + l / 2 + 20 + "px") : (n = a.value.split("%"), C.value = `calc(${Number(n[0])}% + ${l / 2 + 20}px)`)
                }))
            }, L = e => {
                if (!e) return null;
                let t, a, l = e.offsetWidth, n = e.offsetHeight;
                for (0 !== n && 0 !== l || console.warn("You need to set the width and height attribute for the body element"), t = e.offsetTop, a = e.offsetLeft; e = e.offsetParent;) t += e.offsetTop, a += e.offsetLeft;
                return {
                    width: l,
                    height: n,
                    top: t,
                    ...
                    bottom: document.body.offsetHeight - n - t
                }
            }, V = c(null), k = r(), S = e => {
                if (!e) return;
                const t = L(e);
                d.value = window.getComputedStyle(e).width, i.value = window.getComputedStyle(e).height, t && (m.value = t.left + "px", h.value = t.top + "px"), D()
            }, B = t => {
                t ? o.value = setTimeout((() => {
                    v((() => {
                        (() => {
                            if (e.isFullScreen) return x(document.querySelector("body")), void (window.onresize = () => {
                                x(document.querySelector("body"))
                            });
                            S(null == k ? void 0 : k.proxy.$el.parentElement), V.value = null == k ? void 0 : k.proxy.$el.parentElement;
                            const t = V.value;
                            window.onresize = () => {
                                t && S(t)
                            }
                ...
                }), e.delay) : (clearTimeout(o), o.value = null, window.onresize = null)
            }, T = p((() => e.show));
        return M((() => {
            let e = T.value;
            B(e)
...
const Yt = ["id"];
Ft.render = function (e, t, a, l, n, o) {
    const s = P("BeLoadingAnimate");
    return g(), C(D, {to: "body"}, [x("div", {
        id: `be_load_${e.uid}`,
        style: T(`position: fixed;height: ${e.containerHeight};width: ${e.containerWidth};left: ${e.containerLeft};top: ${e.containerTop};`)
    }, [V(k, {name: "be-fade-in-linear"}, {
        default: S((() => [e.isShowLoader ? (g(), f("div", {
            key: 0,
            class: L(["be-load-container", `${e.customClass} ${e.isFullScreenStyle}`]),
            style: T(`\n                 background-color: ${e.bgColor};\n                 left: ${e.leftLoader};\n                 top: ${e.topLoader};\n                 width:${e.loaderWidth};\n                 height:${e.loaderHeight}`)
        }, [V(s), e.text ? (g(), f("span", {
            key: 0,
            class: L(["be-loader-text", `be-loader-text__${e.sizeLoader}`]),
            style: T(`color:${e.colorText};left:${e.leftTxt};top:${e.topTxt}`)
        }, E(e.text), 7)) : z("", !0)], 6)) : z("", !0)])), _: 1
    })], 12, Yt)])
};
const Rt = {
    close: e => {
        ...
        return n && n.append ? n.append(a.el) : n && n.appendChild(a.el), a.beLoadingElm = l, a
    }
};
const jt = Ft;
jt.install = e => {
...
const qt = jt, Kt = (e, t, a, l, n, o) => {
    if (e.isFront) {
        const s = new Map, i = p((() => {
            const i = t.pageNumVal ? Number(t.pageNumVal.split("/")[0]) : e.pageSize;
            a.value = Math.ceil(e.pageData.length / i), t.pageParamsFront.maxPageNum = a.value, e.pageData.length && 0 !== e.pageData.length || (s.set(1, []), t.pageParamsFront.maxPageNum = 1), o.emit("getPageCount", t.pageParamsFront);
            ...
            1 === d && o.emit("updatePage", {data: s.get(1)});
            let p = !1, u = !1;
            ...
            return l.value = p, n.value = u, m
        })), r = () => {
            let t = Number(e.currentPage) > a.value ? a.value : Number(e.currentPage);
            1 !== t && t > 0 && e.isFront && o.emit("updatePage", {data: s.get(--t)})
        }, c = () => {
            let l = Number(e.currentPage) > a.value ? a.value : Number(e.currentPage);
            l !== t.pageParamsFront.maxPageNum && e.isFront && o.emit("updatePage", {data: s.get(++l)})
        };
...
var Xt = i({
    name: "BePager", setup(e, t) {
        const a = $("$$BePaginMix"), l = $("$$BePaginProps");
        let n = c(0), o = c(!1), s = c(!1), i = p((() => ((e, t, a, l) => {
                if (e.isFront || e.isDynamic) return [];
                let n = e.pagerShowCount;
                const o = (n - 1) / 2, s = Number(e.pageCount);
                ...
                let r = !1, c = !1;
                t.value > n && (i > n - o && (r = !0), i < t.value - (n - 2) && (c = !0));
                const d = [];
                if (r && !c) for (let p = t.value - (n - 2); p < t.value; p++) d.push(p); else if (!r && c || !r && !c) for (let p = 2; p < n; p++) d.push(p); else if (r && c) {
                    const e = Math.floor(n / 2) - 1;
                ...
                if (e.isDynamic) {
                    let t = [];
                    const a = Number(e.currentPage) >= 1 ? Number(e.currentPage) : 1, l = Number(e.pagerShowCount),
                        n = parseInt(String(l / 2));
                    if (a <= n) for (let e = 1; e <= l; e++) t.push(e);
                    if (a > n) {
                        const e = a - n;
                ...
                return []
            })(l))), v = d(Kt(l, a, n, o, s, t)), h = c(v ? v.sliceList : null), w = c(v ? v.frontList : null),
            g = c(v ? v.nextPageFront : null), f = c(v ? v.prePageFront : null);
        u(l, (e => {
            v = Kt(e, a, n, o, s, t), w.value = v ? v.frontList : null, h.value = v ? v.sliceList : null, g.value = v ? v.nextPageFront : null, f.value = v ? v.prePageFront : null
        }));
        const y = (e, t, a) => {
            isNaN(e) || (e < 1 && (e = 1), e > t.value && !a.isDynamic && (e = t.value))
        }, x = e => {
            let o = 0;
            o = l.isDynamic ? Number(l.currentPage) : Number(l.currentPage) > n.value ? n.value : Number(l.currentPage);
            let s = 0;
            if ("next" === e ? s = l.isDynamic ? o + 1 : o >= n.value ? o : o + 1 : (s = o - 1, s = s <= 0 ? 1 : s), y(s, n, l), s !== o) {
                l.isFront && ("next" === e ? g.value && g.value() : f.value && f.value());
                const n = {
                    currentPage: s,
        ...
        let b = c("more"), C = c("more"), D = c("#303133"), L = c("#303133");
        M((() => {
            o.value || (C.value = "more")
        })), M((() => {
            s.value || (b.value = "more")
        })), u([s, o], (([e, t]) => {
            e || (b.value = "more"), t || (C.value = "more")
        }));
        return m((() => {
            if (l.isFront) {
                const e = a.pageNumVal ? Number(a.pageNumVal.split("/")[0]) : l.pageSize;
                n.value = Math.ceil(l.pageData.length / e)
            } else {
                const e = Number(l.pageCount);
                n.value = Math.ceil(e / Number(l.pageSize))
            }
        })), {
            pagerMix: a,
            pagerProps: l,
            ...
            hoverprevIconClass: L,
            quicknextIconClass: b,
            hoverNextIconClass: D,
            pagers: i,
            pagersDynamic: r,
            showPrevMore: o,
            showNextMore: s,
            ...
            onPagerClick: (e, o) => {
                let s = 0;
                s = l.isDynamic ? Number(l.currentPage) : Number(l.currentPage) > n.value ? n.value : Number(l.currentPage);
                let i = o;
                if (!o) {
                    ...
                    t.className && "[object String]" === Object.prototype.toString.call(t.className) && -1 !== t.className.indexOf("more") && (-1 !== t.className.indexOf("quickprev") ? i = s - a : -1 !== t.className.indexOf("quicknext") && (i = s + a));
                    const n = null == e ? void 0 : e.target;
                    t.className && "[object SVGAnimatedString]" === Object.prototype.toString.call(t.className) && n.className.baseVal && -1 !== n.className.baseVal.toString().indexOf("be-icon") && (t.parentElement && -1 !== t.parentElement.className.indexOf("quickprev") ? i = s - a : t.parentElement && -1 !== t.parentElement.className.indexOf("quicknext") && (i = s + a))
                }
                if (y(Number(i), n, l), i !== s) {
            ...
            onMouseenter: e => {
                l.disabled || ("left" === e ? (L.value = "#409EFF", C.value = "page-first") : (D.value = "#409EFF", b.value = "page-last"))
            }
        }
    }
});
let Zt;
Xt.render = function (e, t, a, l, n, o) {
    const s = P("be-icon");
    return g(), f("div", null, [x("ul", {class: L(["be-pager", {"be-pager__disabled": e.pagerProps.disabled}])}, [x("li", {onClick: t[0] || (t[0] = (...t) => e.prePage && e.prePage(...t))}, [V(s, {icon: "left"})])], 2), e.pagerProps.isDynamic || e.pagerProps.isFront ? e.pagerProps.isDynamic && !e.pagerProps.isFront ? (g(), f("ul", {
        key: 1,
        onClick: t[6] || (t[6] = (...t) => e.onPagerClick && e.onPagerClick(...t)),
        class: L(["be-pager", {"be-pager__disabled": e.pagerProps.disabled}])
    }, [(g(!0), f(y, null, W(e.pagersDynamic, (t => (g(), f("li", {
        class: L([{
            active: e.pagerProps.currentPage === t,
            disabled: e.pagerProps.disabled
        }, "number"]), key: t
    }, E(t), 3)))), 128))], 2)) : !e.pagerProps.isDynamic && e.pagerProps.isFront ? (g(), f("ul", {
        key: 2,
        onClick: t[11] || (t[11] = (...t) => e.onPagerClick && e.onPagerClick(...t)),
        class: L(["be-pager", {"be-pager__disabled": e.pagerProps.disabled}])
    }, [e.pagerMix.pageParamsFront.maxPageNum > 0 ? (g(), f("li", {
        key: 0,
        class: L([{active: 1 === e.pagerProps.currentPage, disabled: e.pagerProps.disabled}, "number"])
    }, "1 ", 2)) : z("", !0), e.showPrevMore ? (g(), f("li", {
        key: 1,
        class: L([e.quickprevIconClass, {disabled: e.pagerProps.disabled}]),
        onMouseenter: t[7] || (t[7] = t => e.onMouseenter("left")),
        onMouseleave: t[8] || (t[8] = t => {
    ...
    }, null, 8, ["icon", "onClick", "color"])], 34)) : z("", !0), (g(!0), f(y, null, W(e.frontList, (t => (g(), f("li", {
        class: L([{
            active: e.pagerProps.currentPage === t,
            disabled: e.pagerProps.disabled
        }, "number"]), key: t
    }, E(t), 3)))), 128)), e.showNextMore ? (g(), f("li", {
        key: 2,
        class: L([e.quicknextIconClass, {disabled: e.pagerProps.disabled}]),
        onMouseenter: t[9] || (t[9] = t => e.onMouseenter("right")),
        onMouseleave: t[10] || (t[10] = t => {
    ...
    }, null, 8, ["icon", "onClick", "color"])], 34)) : z("", !0), e.pagerMix.pageParamsFront.maxPageNum > 1 ? (g(), f("li", {
        key: 3,
        class: L([{
    ...
    }, E(e.pagerMix.pageParamsFront.maxPageNum), 3)) : z("", !0)], 2)) : z("", !0) : (g(), f("ul", {
        key: 0,
        onClick: t[5] || (t[5] = (...t) => e.onPagerClick && e.onPagerClick(...t)),
        class: L(["be-pager", {"be-pager__disabled": e.pagerProps.disabled}])
    }, [e.pagerProps.pageCount > 0 ? (g(), f("li", {
        key: 0,
        class: L([{active: 1 === e.pagerProps.currentPage, disabled: e.pagerProps.disabled}, "number"])
    }, "1 ", 2)) : z("", !0), e.showPrevMore ? (g(), f("li", {
        key: 1,
        ...
        onClick: A(e.onPagerClick, ["stop"]),
        color: e.hoverprevIconClass
    }, null, 8, ["icon", "onClick", "color"])], 34)) : z("", !0), (g(!0), f(y, null, W(e.pagers, (t => (g(), f("li", {
        class: L([{
            active: e.pagerProps.currentPage === t,
            disabled: e.pagerProps.disabled
        }, "number"]), key: t
        ...
        class: "more btn-quicknext",
        color: e.hoverNextIconClass
    }, null, 8, ["icon", "onClick", "color"])], 34)) : z("", !0), e.maxPageNum > 1 ? (g(), f("li", {
        key: 3,
        class: L([{active: !(e.pagerProps.currentPage < e.maxPageNum), disabled: e.pagerProps.disabled}, "number"])
    }, E(e.maxPageNum), 3)) : z("", !0)], 2)), x("ul", {class: L(["be-pager", {"be-pager__disabled": e.pagerProps.disabled}])}, [x("li", {onClick: t[12] || (t[12] = (...t) => e.nextPage && e.nextPage(...t))}, [V(s, {icon: "right"})])], 2)])
};
const Jt = ["letter-spacing", "line-height", "padding-top", "padding-bottom", "font-family", "font-weight", "font-size", "text-rendering", "text-transform", "width", "text-indent", "padding-left", "padding-right", "border-width", "box-sizing"];

function Qt(e, t = 1, a = null) {
    var l;
    Zt || (Zt = document.createElement("textarea"), document.body.appendChild(Zt));
    const {paddingSize: n, borderSize: o, boxSizing: s, contextStyle: i} = function (e) {
        const t = window.getComputedStyle(e), a = t.getPropertyValue("box-sizing"),
            ...
            n = parseFloat(t.getPropertyValue("border-bottom-width")) + parseFloat(t.getPropertyValue("border-top-width"));
        return {
            contextStyle: Jt.map((e => `${e}:${t.getPropertyValue(e)}`)).join(";"),
            paddingSize: l,
            borderSize: n,
            boxSizing: a
        }
    }(e);
    Zt.setAttribute("style", `${i};\n  height:0 !important;\n  visibility:hidden !important;\n  overflow:hidden !important;\n  position:absolute !important;\n  z-index:-1000 !important;\n  top:0 !important;\n  right:0 !important;\n`), Zt.value = e.value || e.placeholder || "";
    let r = Zt.scrollHeight;
    const c = {};
    "border-box" === s ? r += o : "content-box" === s && (r -= n), Zt.value = "";
    const d = function (e, t) {
        return e - t
    }(Zt.scrollHeight, n);
    if (null !== t) {
        const e = function (e, t, a, l, n, o) {
            let s = t * a;
            return "border-box" === l && (s = s + n + o), s
        }(0, d, t, s, n, o);
        c.minHeight = `${e}px`
    }
    return null !== a && (r = function (e, t, a, l, n, o) {
        if (!a) return;
        let s = t * a;
        return "border-box" === l && (s = s + n + o), Math.min(s, e)
    }(r, d, a, s, n, o) || r), c.height = `${r}px`, null == (l = Zt.parentNode) || l.removeChild(Zt), Zt = null, c
}
...
var ea = i({
    ...
    setup(e, t) {
        const a = U(), l = r(), n = c(e.type), s = c("password" === e.type), i = e => {
            t.emit("update:modelValue", e), t.emit("input", e)
        };
        let h = c(!1);
        const w = c({}), g = () => {
            const {autosize: t} = e;
            if ("textarea" === n.value) if (t) {
                const e = Qe(t) ? t.minRows : void 0, a = Qe(t) ? t.maxRows : void 0;
                w.value = o({}, Qt(b, e, a))
            } else w.value = {minHeight: Qt(b, e.rows).minHeight}
        }, f = p((() => o(o({}, e.inputStyle), w.value)));
        u((() => e.modelValue), (e => {
            v(g)
        }));
        const y = c(null);
        let x = null, b = null;
        v((() => {
            x = l.refs.beInputInner && d(l.refs.beInputInner), b = l.refs.beInputAreaInner && d(l.refs.beInputAreaInner), y.value = "textarea" === n.value ? b : x
        }));
        const C = p((() => y.value));
        return m((() => {
            v(g)
            ...
            handlePassword: () => {
                s.value = !s.value, s.value ? n.value = e.type : n.value = "text"
            },
            handleInput: i,
            handleIcon: e => {
...
const ta = ["id"], aa = {key: 0, class: "be-input-body"},
    la = ["disabled", "placeholder", "value", "maxlength", "tabindex", "aria-label", "type", "id"],
    na = {key: 2, class: "be-input-close-body"}, oa = {key: 1, class: "be-input-body"},
    sa = ["tabindex", "aria-label", "value", "disabled", "placeholder"];
ea.render = function (e, t, a, l, n, o) {
    const s = P("be-icon");
    return g(), f("div", {
        id: `be_input_${e.uid}`,
        class: L(`\n        be-input\n        be-input__${e.size}\n        ${e.disabled ? "be-input__disabled " : ""}\n        ${"textarea" === e.inputType ? "be-input__textarea" : ""}\n        ${e.customClass}`)
    }, [b(e.$slots, "prev"), "textarea" !== e.inputType ? (g(), f("div", aa, [e.prevIcon ? (g(), C(s, {
        key: 0,
        onClick: t[0] || (t[0] = t => e.handleIcon("prev")),
        icon: e.prevIcon,
        class: "be-input-prevIcon"
    }, null, 8, ["icon"])) : z("", !0), x("input", G({
        ref: "beInputInner",
        disabled: e.disabled,
        ...
        onBlur: t[2] || (t[2] = t => e.handleBlur(t.target.value)),
    ...
    }), null, 16, la), e.nextIcon ? (g(), C(s, {
        key: 1,
        onClick: t[8] || (t[8] = t => e.handleIcon("next")),
        icon: e.nextIcon,
        class: "be-input-nextIcon"
    }, null, 8, ["icon"])) : z("", !0), e.isInner ? z("", !0) : (g(), f("div", na, [B(V(s, {
        onClick: e.handleClear,
        icon: "deleteIc",
        class: "be-input-icon be-input-close"
    }, null, 8, ["onClick"]), [[F, e.showClearIcon]])])), B(V(s, {
        onClick: e.handlePassword,
        icon: "" + (e.isPassWord ? "no-eye" : "eye"),
        class: "be-input-icon be-input-password"
    }, null, 8, ["onClick", "icon"]), [[F, e.showPassword]])])) : z("", !0), b(e.$slots, "next"), "textarea" === e.inputType ? (g(), f("div", oa, [x("textarea", G({
        ...
        disabled: e.disabled,
        placeholder: e.placeholder,
        onFocus: t[9] || (t[9] = t => e.handleFocus(t.target.value, t)),
        onBlur: t[10] || (t[10] = t => e.handleBlur(t.target.value)),
        onChange: t[11] || (t[11] = (...t) => e.handleChange && e.handleChange(...t)),
        onKeydown: t[12] || (t[12] = (...t) => e.handleKeydown && e.handleKeydown(...t)),
        onInput: t[13] || (t[13] = t => e.handleInput(t.target.value))
    }), "\r\n            ", 16, sa)])) : z("", !0)], 10, ta)
};
var ia = i({
    name: "BeInputSelect", props: {
        selectList: {
            type: Object, default: () => {
            }
        },
...
const ra = ["id"], ca = ["id"], da = ["onClick"], pa = {key: 1, class: "be-input-select__inner"},
    ua = [x("li", {class: "be-input-select__line"}, null, -1), x("li", {
        class: "be-input-select__inner",
        style: {"text-align": "center"}
    }, " 载入中... ", -1)];
ia.render = function (e, t, a, l, n, o) {
    return g(), C(k, {name: "be-zoom-in-top"}, {
        default: S((() => [x("div", {
        ...
        }, [e.list.length > 0 ? (g(!0), f(y, {key: 0}, W(e.list, ((t, a) => (g(), f("li", {
            class: "be-input-select__inner",
            key: t[e.keyValue],
            onClick: l => e.handleSelect(t, a)
        }, [b(e.$slots, "cus-temp", {item: t}, (() => [_(E(t[e.labelValue]), 1)]))], 8, da)))), 128)) : z("", !0), 0 === e.list.length ? (g(), f("li", pa, " 暂无数据 ")) : z("", !0)], 12, ca)), [[F, !e.loading]]), B((g(), f("ul", {key: `be-input-select${e.uid}-loading`}, ua, 512)), [[F, e.loading]])], 12, ra)])),
        _: 3
    })
};
var ma = i({
    name: "BeAutocomplete",
    components: {BeInputSelect: ia, BeInput: ea, BePopover: it},
    ...
    setup(e, t) {
        ...
        let p = d({width: "0px"}), u = c(e.suggestionList);
        const h = e => {
            e && (p.width = Number(window.getComputedStyle(e).width.split("px")[0]) + "px")
        }, w = (t, a) => {
            v((() => {
                u.value = t ? a.filter((a => a[e.labelValue].toString().toLowerCase().indexOf(t.toLowerCase()) >= 0)) : a
            }))
        }, g = () => {
        ...
        const y = c(!1), x = (t = (() => {
            ...
            v((() => {
                e.fetchSuggestions && 0 === f.length && (y.value = !0, e.fetchSuggestions((e => {
                    u.value = at(e), f = at(e), y.value = !1
                }))), t && t(f)
            }))
        };
        return m((() => {
            ...
            loading: y, selectList: u, handleSelect: (e, a) => {
                n.value = e.label, o(), t.emit("select", e, a);
                l.refs.beInputPopover.close(), f = []
            }, selectStyle: p, focusTrigger: i, uid: l.uid, attrs: a, valInner: n, handleChange: o, handleInput: () => {
                let a = e.suggestionList.length > 0 ? e.suggestionList : f;
                e.focusTrigger ? w(n.value, a) : e.fetchSuggestions ? x((e => {
                    w(n.value, e), g()
                })) : (w(n.value, a), g()), t.emit("update:modelValue", n.value), t.emit("input", n.value)
            }, handleBlur: () => {
                t.emit("blur", n.value)
            }, handleFocus: (a, l) => {
                const o = l.target.parentElement;
                s = o, h(o), t.emit("focus", n.value), e.fetchSuggestions && e.focusTrigger && x()
            }, handleIconClickPrev: () => {
...
ma.render = function (e, t, a, l, n, o) {
    const s = P("be-input"), i = P("be-input-select"), r = P("be-popover");
    return g(), C(r, {
        trigger: e.focusTrigger ? "manual" : "none",
        placement: "bottom",
        ref: "beInputPopover",
        "trigger-elm": `be_input_select_inner_${e.uid}`,
        "custom-class": "be-input-select-popover"
    }, {
        trigger: S((() => [V(s, G({id: `be_input_select_inner_${e.uid}`}, e.attrs, {
            ...
            prev: S((() => [b(e.$slots, "prev")])),
            next: S((() => [b(e.$slots, "next")])),
            _: 3
        }, 16, ["id", "onChange", "onInput", "onFocus", "onBlur", "onClear", "onPrevIconClick", "onNextIconClick", "modelValue"])])),
        default: S((() => [V(k, {name: "dialog-fade"}, {
            default: S((() => [V(i, {
                ...
                "cus-temp": S((t => [b(e.$slots, "cus-temp", {item: t.item})])),
                _: 3
            }, 8, ["onSelect", "loading", "labelValue", "selectStyle", "select-list"])])), _: 3
        })])),
        _: 3
...
var va = i({
    name: "BePagination",
    components: {Pager: Xt, beAutocomplete: ma},
    props: {
    ...
    setup(e, t) {
        const a = r();
        let l = d({maxPageNum: 0}), n = c("");
        const o = t => {
            if ("Enter" === t.key && null !== t.target) {
                const n = e.pageCount ? e.pageCount : 0, o = Math.ceil(n / Number(e.pageSize)),
                    s = e.isFront ? l.maxPageNum : o, i = t.target.value;
        ...
        let s = c("");
        const i = e => {
            s.value = e.label + "/页", t.emit("updateNum", e.label)
        };
        m((() => {
            s.value = e.pageSize + "/页"
        }));
        const p = e => {
            t.emit("updatePage", e)
        }, u = e => {
            ...
            const t = e.pageCount ? e.pageCount : 0, a = Math.ceil(t / Number(e.pageSize)),
                n = e.isFront ? l.maxPageNum : a;
            return V("span", {class: "be-pager-info"}, [_("第"), e.currentPage > n ? n : e.currentPage, _("页/共"), n, _("页")])
        }, w = () => {
            const t = !!e.disabled || !!e.disabledJump;
            return V("div", {class: "be-pager-jump"}, [_("跳至"), V("input", {
                disabled: t,
        ...
        Y("$$BePaginProps", e);
        let g = d({jumpPage: n.value, pageParamsFront: l, pageNumVal: s.value});
        return Y("$$BePaginMix", g), () => {
            const t = {onUpdatePage: p, onChangePage: v, onGetPageCount: u}, l = a.slots.next ? a.slots.next : () => {
            }, n = a.slots.prev ? a.slots.prev : () => {
            };
            let o = {
                page: V(Xt, G({ref: "pager"}, t), null),
                jump: w.call(this),
                info: h.call(this),
                next: l(),
                prev: n(),
            ...
            return e.isDynamic || (o.pNum = V(P("be-select"), {
                modelValue: s.value,
                ...
                list: e.pageNum,
                onSelect: i
            }, null)), V("div", {class: "be-pager-container"}, [e.layout.map((e => Object(o)[e]))])
        }
    }
});
va.install = e => {
...
var fa = i({
    name: "be-select",
    components: {BeInputSelect: ia, BePopover: it, BeIcon: wt},
    ...
    setup(e, t) {
        let {
            ...
            const a = r(), l = a.uid, n = c([]), o = p((() => e.list)), s = c(!0);
            e.search && (s.value = !1);
            let i = e.disabled ? "not-allowed" : s.value ? "pointer" : "", u = d({width: "0px"});
            const m = U(), h = c(p((() => e.selectIcon)).value), w = t => {
                e.clear && e.modelValue && (h.value = t || "error")
            }, g = () => {
                t.emit("scroll")
            }, f = c(""), y = c("click");
            e.remote && st(e.remoteFunc) && (y.value = "none");
            const x = c(!1), b = c([]);
            return {
                internalInstance: a,
                uid: l,
                ...
                addItemToList: () => {
                    if (f.value) {
                        let t = {}, a = e.keyValue || "id", l = e.keyValue || "label";
                        t[a] = et(), t[l] = f.value, n.value.push(t), f.value = ""
                    }
                },
                computedPosition: () => {
        ...
        const N = t => {
            ...
            if (e.group) {
                ...
                e.isSelect = !1, e.id = et()
            })), e.keyValue && a.forEach((t => {
                t.isSelect = !1, t[e.keyValue || "id"] || (t[e.keyValue || "id"] = et())
            })), n.value = a;
            i = at(n.value)
        }, H = () => {
            if (e.extend && !e.group) return V("div", {class: "\n                        be-select-option__extend"}, [V(P("be-input"), {
                value: C.value,
                onInput: D
            }, null), V(P("be-icon"), {icon: "add", onClick: L}, null)])
        }, _ = (a, l) => {
            if ($.value.length >= Number(e.max) && e.max) return;
            let o = at(a);
            let s = at(l), i = [];
            if (o) {
                let a = o.indexOf(",") >= 0;
                ...
                let r = $.value.map((e => e.label));
                l = [...new Set([...r, ...l])];
                let c = [], d = [];
                l.forEach((e => {
                    let t = ((e, t, a) => {
                        let l = e ? t.filter((t => t[a].toString().toLowerCase().indexOf(e.toLowerCase()) >= 0)) : t;
                        return {data: l.length > 0 ? at(l) : at(t), isHas: l.length > 0}
                    })(e, s, F), l = {};
                    if (l[F] = e, t.isHas) {
                        if (a) {
                            let t = !1;
                            n.value.forEach((a => {
                                e === a[F] && (t = !0, R.has(a[Y]) || R.set(a[Y], a))
                            })), t || (l.isAutoAdd = !0, l[Y] = et(), R.set(l[Y], l), d.push(l), s.push(l)), j()
                        }
                        c = ((e, t) => {
                            let a = {};
                            return e.reduce(((e, l) => (!a[l[t]] && (a[l[t]] = e.push(l)), e)), [])
                        })([...t.data, ...c], Y)
                    } else l[Y] = et(), a && (l.isAutoAdd = !0, R.set(l[Y], l), j(), b.value.push(l)), l.isAutoAdd = !0, d.push(l), s.push(l)
                })), i = c.concat(d), e.sortFunc && i.sort(e.sortFunc), t.emit("search", i), n.value = a ? s : i
            } else n.value = at(l);
            $.value.forEach((e => {
                q(!0, e[Y])
            }))
            ...
            const n = l.target;
            A.value = n.value, W.value = K(n.value), S(), t.emit("change", n);
            const o = a.refs.beSelectPopover;
            if (e.remote && st(e.remoteFunc) && e.remoteFunc) {
                return function (e, t) {
                    let a;
                    return function () {
                        const l = this, n = [...arguments];
                        a && clearTimeout(a);
                        const o = !a;
                        a = setTimeout((() => {
                            a = null
                    ...
                    n.value ? (o.changeDisplay(!0), x.value = !0, e.remoteFunc && e.remoteFunc((e => {
                        x.value = !1, N(e), _(n.value, i)
                    }))) : o.close()
                }), 300).call(this)
            }
            _(n.value, i.concat(b.value))
        }, $ = c([]), A = c(""), W = c(0), F = e.labelValue || "label", Y = e.keyValue || "id";
        let R = new Map;
        const j = () => {
            const e = at((e => {
                let t = [];
            ...
            $.value = e, t.emit("update:modelValue", e)
        }, q = (e, t) => {
            n.value.forEach((a => {
                a[Y] === t && (a.isSelect = e)
            }))
        ...
        m((() => {
            N(e.list), B(), $.value = e.modelValue, $.value.forEach((e => {
                e.isSelect = !0, R.set(e[Y], e), q(!0, e[Y])
            }))
        }));
        const X = () => {
            var l;
            if (!$.value || 0 === (null == (l = $.value) ? void 0 : l.length)) return;
            let o = at($.value);
            if (e.maxTag && $.value.length > Number(e.maxTag)) {
                o = o.slice(0, Number(e.maxTag));
                let t = {};
                t[Y] = et(), t[F] = "+" + ($.value.length - Number(e.maxTag)), t.isNum = !0, o.push(t)
            }
            let s = [];
            return o.forEach(((e, l) => {
                s.push(V("div", {class: "be-select-tag"}, [a.slots.tag ? a.slots.tag({
                    data: e,
                    index: l
                }) : V(P("be-tag"), {
                    key: e.label + "tag",
                    ...
                    className: "ellipsis",
                    onClose: () => (e => {
                        const a = e.isNum ? $.value.pop() : e;
                        R.delete(a[Y]), q(!1, a[Y]), a.isAutoAdd && (b.value = b.value.filter((e => e[Y] !== a[Y])), n.value = i.concat(b.value)), j(), S(), t.emit("closeTag", a)
                    })(e)
                }, {default: () => [e[F]]})]))
            })), s
        }, Z = () => {
            ...
            return n.value.forEach(((s, r) => {
                o.push(V("div", {
                    ...
                    key: s[l],
                    onClick: () => {
                        s.disabled || "group" === s.type || ((a, l) => {
                            if ($.value.length >= Number(e.max) && e.max) return;
                            const o = a[Y];
                            R.has(o) ? (a.isAutoAdd && (b.value = b.value.filter((e => e[Y] !== a[Y]))), R.delete(o), a.isSelect = !1, t.emit("Deselect", a, l)) : (a.isAutoAdd && b.value.push(a), R.set(o, a), a.isSelect = !0, t.emit("select", a, l)), t.emit("change", a), A.value = "", n.value = i.concat(b.value), j(), $.value.forEach((e => {
                                q(e.isSelect, e[Y])
                            })), S()
                        })(s, r)
                    }
                    ...
                    data: s,
                    index: r
                }) : s[e.labelValue], s.isSelect ? V(P("be-icon"), {
                    icon: "select",
                    "custom-class": "be-select-hook"
                }, null) : ""]))
            })), o
        };
        return () => V("div", {id: `be_select-${l}`, class: "be-select"}, [V(P("be-popover"), {
            onUpdate: E,
            trigger: y.value,
            placement: "bottom",
            ref: "beSelectPopover",
            ...
            trigger: V("div", {
                ...
                disabled: e.disabled,
                onInput: e => O(e),
                style: {cursor: w, width: W.value + "px"},
                class: `be-select-input be-select-input__${e.size}`
            }, null), V(P("be-icon"), {
                icon: f.value, onClick: a => {
                    "error" === f.value && (R = new Map, $.value = [], A.value = "", W.value = 0, t.emit("clear"), j(), I(e.selectIcon), n.value = i, a.stopPropagation())
...
var xa = i({
    ...
    setup(e, t) {
        ...
        return o = {
            ...
            color: (null == (n = e.option) ? void 0 : n.color) || ""
        }, {
            handleClose: a => {
...
xa.render = function (e, t, a, l, n, o) {
    var s, i;
    const r = P("be-icon");
    return g(), f("div", {
        style: T(e.styleOption),
        class: L(`\n  be-tag\n  be-tag__${e.disabled ? "disabled" : ""}\n  be-tag__${e.type}\n  be-tag__${e.size}`)
    }, [x("span", {style: T({color: null == (s = e.styleOption) ? void 0 : s.color})}, [b(e.$slots, "default")], 4), e.isClose ? (g(), C(r, {
        key: 0,
        icon: "deleteIc",
        class: "be-tag_close",
...
var Da = i({
    ...
    components: {beInput: wa, beIcon: Ct},
    ...
    setup(e, t) {
        const a = r(), l = a.uid, n = U(), o = c(1), s = c(""), i = e => {
            t.emit("update:modelValue", e)
        }, h = t => {
            if (!t) return {val: t, type: ""};
            const a = Number(t), l = "" !== e.max ? Number(e.max) : null, n = "" !== e.min ? Number(e.min) : null;
            return l && n && n <= a && a <= l && l && n || !l && !n || n && a >= n && !l || l && a <= l && !n ? {
                val: a,
                type: ""
            } : n && a < n ? {val: n, type: "limit"} : l && a > l ? {val: l, type: "limit"} : void 0
        }, w = () => {
            ...
            const a = (e => {
                ...
                return e.forEach(((e, l) => {
                    let n = Math.round(e * Math.pow(10, a));
                    0 === l ? t = n : t -= n
                })), t / Math.pow(10, a)
            ...
            const a = ((e, t) => {
                ...
                return n = Math.pow(10, Math.max(a, l)), (e * n + t * n) / n
            })(Number(e.modelValue), Number(e.step));
        ...
        const y = p((() => f.value)), x = p((() => e.modelValue));
        u(x, (t => {
            t && (s.value = e.formatter(t))
        }));
        const b = p((() => h(e.modelValue).type));
        return m((() => {
            (e.modelValue && tt(e.modelValue.toString()) || 0 === e.modelValue) && (s.value = e.formatter(e.modelValue))
        })), {
            uid: l,
            attrs: n,
            inputInnerVal: s,
            ...
            renderPreSlot: () => a.slots.pre ? V("div", {class: "be-input-number__pre"}, [a.slots.pre()]) : "",
            handleInput: t => {
            ...
            handleIncrease: g,
            handleReduce: w,
            renderNextSlot: () => a.slots.next ? V("div", {class: "be-input-number__next"}, [a.slots.next()]) : "",
            handleKeyDown: a => {
                e.keyboard && ("ArrowUp" === a.key && g(), "ArrowDown" === a.key && w(), "Enter" === a.key && t.emit("pressEnter", e.modelValue))
            }
        }
    },
    render() {
        return V("div", {
            ...
            tabindex: "0"
        }, [this.renderPreSlot(), V("div", {class: `be-input-number__${this.size} be-input-number__default`}, [V(P("be-input"), G({
...
const Va = i({
    ...
    setup(e, t) {
        ...
        return m((() => {
            void 0 !== e.unCheckedValue && "" !== e.unCheckedValue && (lt(e.unCheckedValue) || nt(e.unCheckedValue) || ot(e.unCheckedValue)) && e.modelValue === e.unCheckedValue && (a.value = !1), void 0 !== e.checkedValue && "" !== e.checkedValue && (lt(e.checkedValue) || nt(e.checkedValue) || ot(e.checkedValue)) && e.modelValue === e.checkedValue && (a.value = !0)
        })), () => {
            const t = n.slots.unCheckedRender ? V("div", {class: `be-switch__${e.size}_slot_un_checked`}, [_(" "), n.slots.unCheckedRender(a.value)]) : "",
                s = n.slots.checkedRender ? V("div", {class: `be-switch__${e.size}_slot_checked`}, [n.slots.checkedRender(a.value)]) : "";
            return V("div", {
                class: `\n                        be-switch\n                        be-switch__${e.size}\n                        ${e.disabled || e.isLoading ? "be-switch__disabled" : ""}\n                        ${a.value ? "be-switch__checked" : "be-switch__unChecked"}\n                        ${l.value}\n                        ${e.customClass}\n                    `,
                tabindex: "0",
                onClick: e => o(e)
            }, [a.value ? t : "", V("div", {class: "be-switch-circle"}, [e.isLoading ? V(P("be-icon"), {
                spin: !0,
                icon: "loading",
...
var Sa = i({
    name: "BeBreadcrumb", setup() {
        ...
        return t.length > 0 && "BeBreadcrumbItem" === t[t.length - 1].type.name && (t[t.length - 1].beBreadcrumbIndex = "last"), () => V("div", {
            class: "be-breadcrumb",
            "aria-label": "BeBreadcrumb"
        }, [t])
    }
});
const Ba = "undefined" != typeof window ? window : null;
var Ta = i({
    name: "BeBreadcrumbItem",
    components: {"be-popover": St},
    props: {
    ...
    setup(e, t) {
        const a = r(), l = a.uid, n = ((e = Ba) => {
                const t = () => {
                    ...
                    return {hash: t, host: a, hostname: l, href: n, origin: o, pathname: s, port: i, protocol: r, search: c}
                }, a = () => {
                    l.value = t()
                }, l = c(t());
                return m((() => {
            ...
            })(), o = p((() => e.to && !e.click ? "a" : "span")), s = p((() => n.value.href === e.to ? "location" : null)),
            i = t => {
                e.clickOption && e.clickOption(t);
                a.refs.beBreadcrumbPopover.close()
            }, d = p((() => e.option)), u = () => {
                let e = [];
                return d.value.forEach((t => {
                    e.push(V("li", {key: t.id, class: "be-breadcrumb-item-li", onClick: i}, [t.label]))
                })), e
            }, h = () => V("div", {
                ...
                onClick: t => {
                    return l = t, void ("last" === a.vnode.beBreadcrumbIndex || d.value.length > 0 || e.disabled ? l.preventDefault() : e.click && !e.disabled && (l.preventDefault(), e.click(l)));
                    var l
                }
            }, [N(o.value, {"aria-current": s.value, href: e.to}, a.slots.default ? a.slots.default() : "")]);
        return m((() => {
            v((() => {
                const e = a.refs.beBreadcrumbPopover;
                d.value.length > 0 && e.addEvent(a.refs.BeBreadcrumbItem)
            }))
        })), () => V("div", {
            class: `\n                     be-breadcrumb-item\n                     ${e.disabled ? "be-breadcrumb-item__disabled" : ""} `,
            "aria-label": "BeBreadcrumbItem"
        }, [d.value.length > 0 ? V(P("be-popover"), {
            ...
            default: () => V("ul", null, [u()]),
            trigger: () => h()
        }) : h(), V("div", {class: "be-breadcrumb-item__separator"}, [a.slots.separator ? a.slots.separator() : e.separator])])
    }
});
const za = Sa;
za.install = e => {
...
var Ga = i({
    ...
    setup(e, t) {
        const a = r(), l = a.uid;
        Y("$$contextmenu", a);
        const n = p((() => ["be-contextmenu", `be-contextmenu__${e.theme}`]));
        p((() => o.value ? x : () => {
        }));
        const o = c(!1), s = c([]);
        u(o, (e => {
            ...
            document.body.removeChild(a.vnode.el), delete window.$BeContextmenu[l], s.value.forEach((t => {
                t.el.removeEventListener(e.eventType, w)
        ...
        const w = l => {
            const n = l;
            if (n.preventDefault(), e.disabled) return;
            const o = n.target, r = document.getElementById("app") || document.body,
                c = s.value.find((e => (e.el.contains = r.contains, e.el.contains(o))));
            t.emit("contextmenu", c ? c.vnode : null);
            const d = n.pageX, p = n.pageY;
            g(), v((() => {
                let e = {top: p, left: d};
                const t = a.refs.contextmenu, l = t.clientWidth, n = t.clientHeight;
                n + p >= window.innerHeight && (e.top -= n), l + d >= window.innerWidth && (e.left -= l), i.top = `${e.top}px`, i.left = `${e.left + 3}px`
            }))
        }, g = e => {
            Object.keys(window.$BeContextmenu).forEach((e => {
                e !== l.toString() && window.$BeContextmenu[e].proxy.hide()
            })), e && (i.top = `${e.top}px`, i.left = `${e.left}px`), o.value = !0
        }, f = p((() => "click" === e.eventType)), y = e => {
            const t = e.target;
            a.vnode.el.contains(t) || f && s.value.some((e => e.el.contains(t))) || (o.value = !1)
        }, x = () => {
            o.value = !1
        };
        return {
            addRef: t => {
                s.value.push(t), t.el.addEventListener(e.eventType, w)
            }, hide: x, hideAll: () => {
                Object.keys(window.$BeContextmenu).forEach((e => {
                    window.$BeContextmenu[e].proxy.hide()
                }))
            }, beContextmenuId: l, visible: o, style: i, contextmenuCls: n, attrs: a.attrs
        }
    }
});
Ga.render = function (e, t, a, l, n, o) {
    return B((g(), f("ul", G({ref: "contextmenu"}, e.attrs, {
        class: e.contextmenuCls,
        style: e.style
    }), [b(e.$slots, "default")], 16)), [[F, e.visible]])
};
var Ia = i({
    ...
    setup(e, t) {
        ...
        return {
            classname: p((() => ({
                ...
                e.disabled || (t.emit("click", l, a), e.autoHide && n.proxy.hide())
            }, handleMouseleave: n => {
                e.disabled || (a.value = !1, t.emit("mouseleave", l, n))
            }, handleMouseenter: n => {
                e.disabled || (a.value = !0, t.emit("mouseenter", l, n))
            }
        }
    }
});
const Na = {key: 0, class: "be-contextmenu-divider"};
Ia.render = function (e, t, a, l, n, o) {
    return e.divider ? (g(), f("li", Na)) : (g(), f("li", {
        key: 1,
        class: L(e.classname),
...
var Ha = i({
    ...
    setup(e, t) {
        ...
        return {
            hover: a, classname: o, submenuCls: s, handleMouseenter: o => {
                if (e.disabled) return;
                const {target: s} = o, i = s.getBoundingClientRect();
                a.value = !0, t.emit("mouseenter", n, o), v((() => {
                    const e = n.refs.submenu, t = e.clientWidth, a = e.clientHeight, o = [];
                    i.right + t >= window.innerWidth ? o.push("left") : o.push("right"), i.bottom + a >= window.innerHeight ? o.push("bottom") : o.push("top"), l.value = o
                }))
            }, handleMouseleave: l => {
                e.disabled || (a.value = !1, t.emit("mouseleave", n, l))
            }
        }
    }
});
const _a = {class: "be-contextmenu-submenu__title"};
Ha.render = function (e, t, a, l, n, o) {
    return g(), f("li", {
        class: L(e.classname),
    ...
    }, [x("span", _a, [b(e.$slots, "title", {}, (() => [_(E(e.title), 1)]))]), B(x("div", {
        ref: "submenu",
        class: L(e.submenuCls)
    }, [x("ul", null, [b(e.$slots, "default")])], 2), [[F, e.hover]])], 34)
};
Ga.install = e => {
...
Aa.render = function (e, t, a, l, n, o) {
    return g(), f("section", {class: L(["be-container", {"be-container__vertical": e.isVertical}])}, [b(e.$slots, "default")], 2)
};
var Wa = i({
    name: "BeAside",
...
Wa.render = function (e, t, a, l, n, o) {
    return g(), f("aside", {class: "be-aside", style: T(e.style)}, [b(e.$slots, "default")], 4)
};
var Ua = i({name: "BeMain"});
const Fa = {class: "be-main"};
Ua.render = function (e, t, a, l, n, o) {
    return g(), f("main", Fa, [b(e.$slots, "default")])
};
var Ya = i({
    name: "BeFooter",
...
Ya.render = function (e, t, a, l, n, o) {
    return g(), f("footer", {class: "be-footer", style: T(e.style)}, [b(e.$slots, "default")], 4)
};
var Ra = i({
    name: "BeHeader",
    props: {height: {type: String, default: null}},
...
Ra.render = function (e, t, a, l, n, o) {
    return g(), f("header", {class: "be-header", style: T(e.style)}, [b(e.$slots, "default")], 4)
};
Aa.install = e => {
...
var Ja = i({
    ...
    setup(e, t) {
        ...
        const l = r();
        let n = e.option;
        const o = c(null == (a = e.option) ? void 0 : a.loading), s = p((() => n.offsetTop));
        "topLeft" !== n.placementSelf && "topRight" !== n.placementSelf && "topCenter" !== n.placementSelf || (n.style = {top: s.value + "px"});
        const i = p((() => n.offsetBottom));
        "bottomLeft" !== n.placementSelf && "bottomRight" !== n.placementSelf || (n.style = {bottom: i.value + "px"});
        const u = p((() => n.placement));
        n.placementSelf = u.value, "bottomLeft" !== n.placementSelf && "bottomRight" !== n.placementSelf || (n.style = {bottom: n.offsetBottom + "px"}), "topLeft" !== n.placementSelf && "topRight" !== n.placementSelf && "topCenter" !== n.placementSelf || (n.style = {top: n.offsetTop + "px"});
        ...
        let h = c("");
        (() => {
            let t = `be-${e.compType} be-${e.compType}__${n.msgType} be-${e.compType}__${n.placement} ${n.customClass}`;
            h.value = t, ("bottomRight" === n.placement || "topRight" === n.placement && !n.isUpdate) && (h.value = t + ` be-${e.compType}-animation-right-in be-${e.compType}-bottom`), ("bottomLeft" === n.placement || "topLeft" === n.placement && !n.isUpdate) && (h.value = t + ` be-${e.compType}-animation-left-in be-${e.compType}-top`), "topCenter" !== n.placement || n.isUpdate || (h.value = t + ` be-${e.compType}-animation-top-center-in be-${e.compType}-top`)
        })();
        let w = l.uid;
        const g = function (t) {
            const a = {onClick: e => v(e)};
            return t(V("div", {class: `be-${e.compType}-container be-${e.compType}-container__${n.placement}`}, [V("div", {class: `be-${e.compType}-title`}, [V("div", {
                class: `be-${e.compType}-head`,
                id: `be_${e.compType}_head${w}`
            }, [V("div", null, [o.value ? V(wt, {
                icon: "loading",
                spin: !0,
                customClass: `icon-${n.msgType}`
            }, null) : n.iconPreRender ? n.iconPreRender : V(wt, {
                icon: `${n.msgType}`,
                customClass: `icon-${n.msgType}`
            }, null), V("span", {class: `txt-${n.msgType}`}, [n.titles])]), V("div", {id: `be_${e.compType}_close_icon${w}`}, [n.closeRender ? n.closeRender : n.close ? V(wt, G({icon: "deleteIc"}, a), null) : ""])])]), "notification" === e.compType ? V("div", {class: `be-${e.compType}-body`}, [n.bodyRender ? n.bodyRender() : V("p", {class: `be-${e.compType}-description`}, [n.description])]) : ""]))
        };
        return () => (clearTimeout(n.timer), n.timer = 0, n.duration > 0 && (n.timer = setTimeout((() => {
            v(null)
        }), n.duration)), V("div", {
            style: n.style, onClick: e => {
                (e => {
                    m.onClick && m.onClick(e)
                })(e)
            }, class: h.value, id: `be_${e.compType}${w}`
        }, [n.isShow ? g.call(this, N) : ""]))
    }
});
let Qa = {topLeft: [], topRight: [], bottomLeft: [], topCenter: [], bottomRight: []}, el = !1;
const tl = function (e, t = !1) {
    if (!e) return;
    let a = -1, l = e.props && e.props.option.placement;
    const n = e.component && e.component.uid || e.uid, o = e.el || e.ctx.$el;
    let s = Object(Qa)[l], i = /^top-/.test(l) ? "top" : "bottom", r = s.length;
    if (t) return void nl();
    try {
        s.forEach(((e, t) => {
            if (n === e.instance.component.uid) throw a = t, new Error("EndIterative")
        }))
    } catch (p) {
    ...
    Object(Qa)[l] = Object(Qa)[l].filter((e => e.instance.component.uid !== n)), e.props.option.onClose && e.props.option.onClose(), al(o, c.elm)
}, al = (e, t) => {
    e && e.parentNode && (ll(e), setTimeout((() => {
        O(null, t)
    }), 300))
}, ll = e => {
    let t = e.className;
    ...
    Object.keys(Qa).forEach((e => {
        Object(Qa)[e].forEach((e => {
            al(e.instance.el, e.elm)
        }))
    })), ol()
}, ol = () => {
    Qa = {topLeft: [], topRight: [], bottomLeft: [], topCenter: [], bottomRight: []}
}, sl = (e, t, a, l, n = !1) => {
    let o = null, s = l;
    if (s) {
        let a = e.placement || "topRight", l = Object(Qa)[a], n = null, o = null;
        if (l.forEach(((e, t) => {
            e.instance.component.uid === s.instance.component.uid && (n = e.elm, o = t)
        })), !n || !o && 0 !== o) return;
        l.splice(o, 1), O(null, n), s = sl(e, t, !1, null, !0)
    } else {
        e.isUpdate = n, s = V(Ja, {
            option: e,
            compType: e.compType
        }), s.props.option.isShow = !0, o = document.createElement("div"), O(s, o);
        const t = document.querySelector("body");
        t && t.append ? t.append(s.el) : t && t.appendChild(s.el)
    }
    return a || t.push({instance: s, elm: o}), s
}, il = function (e) {
    el = !1;
    const t = {
        isShow: !1,
    ...
    let l = Object.assign({}, t, e), n = [];
    n = void 0 === l.placement ? Qa.topRight : Object(Qa)[l.placement];
    let o = null;
    return l.key && n.forEach((e => {
        e.instance.props.option.key === l.key && (el = !0, l = Object.assign({}, e.instance.props.option, a), o = e)
    })), o = sl(l, n, el, o), ((e, t, a, l) => {
        let n = 30, o = "";
        "topLeft" !== e.placement && "topRight" !== e.placement && "topCenter" !== e.placement || (n = e.offsetTop || 30, o = "top"), "bottomLeft" !== e.placement && "bottomRight" !== e.placement || (n = e.offsetBottom || 30, o = "bottom"), a || t.forEach(((t, a) => {
            if (n += (t.instance.el.childNodes[0].offsetHeight || 0) + 35, 0 === a && "message" === (null == e ? void 0 : e.compType)) {
                const t = /top/.test(String(e.placement)) ? e.offsetTop || 0 : e.offsetBottom || 0;
                n = 30 + t
            }
        })), l.el.style[o] = n + "px"
    })(l, n, el, o), {notify: o, close: tl.bind(this, o)}
}, rl = e => il(e);
var cl = {service: rl}, dl = i({
    name: "BeMessageBox",
    directives: {drag: Et},
    components: {
        "be-icon": R((() => Promise.resolve().then((function () {
            return kt
        }))))
    },
    props: {
        ...
        customClass: {type: String, default: ""},
        isOpenModal: {type: Boolean, default: !0},
        msgType: {type: String, default: "warning"},
    ...
    setup(e, t) {
        ...
        l.value = e.isShow;
        const n = () => {
            l.value = !1, e.onClose && e.onClose()
        }, o = () => {
            e.onConfirm && e.onConfirm(), n()
        }, s = c(""), i = p((() => e.isOpenModal));
        u(i, (e => {
            s.value = e ? "be-modal" : ""
        }));
        const d = c(""), v = p((() => d.value));
        return m((() => {
            e.isOpenModal && (s.value = "be-modal"), (() => {
                let e = "be-message-box-container";
                d.value = e + " be-fadeOut", setTimeout((() => {
                    d.value = e + " be-fadeIn"
                }), 100)
            })()
        })), () => {
            if (l.value) return V("div", {class: `be-message-box be-message-box__${e.msgType} ${s.value} ${e.customClass}`}, [B(V("div", {
                class: v.value,
                id: `be_message_box_container${a}`
            }, [V("div", {class: "be-message-box-title"}, [V("div", {
                class: "be-message-box-head",
                id: `be_message_box_head${a}`
            }, [V("div", null, [e.iconPreRender ? e.iconPreRender() : V(P("be-icon"), {
                icon: `${e.msgType}`,
                class: `icon-${e.msgType}`
            }, null), V("span", {class: `text-${e.msgType}`}, [e.titles])]), V("div", {class: "be-message-box-head-close"}, [e.iconNextRender ? V("div", {onClick: () => n()}, [e.iconNextRender()]) : V(P("be-icon"), {
                icon: "deleteIc",
                onClick: () => n()
            }, null)])])]), V("div", {class: "be-message-box-body"}, [e.bodyRender ? e.bodyRender() : ""]), V("div", {class: `be-message-box-footer be-message-box-footer__${e.footerType}`}, [e.footerRender ? V("div", {onClick: () => o()}, [e.footerRender()]) : V("button", {
                class: `be-button be-button__mini be-button__${e.msgType}`,
                onClick: () => o()
            }, [_("知道了")])])]), [[w("drag"), {isDrag: e.isDrag}]])])
        }
    }
});
const pl = e => ({
    msg: (e => {
        ...
        const n = document.querySelector("body");
        n && n.append ? n.append(l.el) : n && n.appendChild(l.el)
    })(Object.assign({}, {
        isDrag: !1,
        titles: "",
        customClass: "",
...
var ul = {service: e => pl(e)};
const ml = {close: Rt.close, init: Rt.init};
var vl = {
...
const hl = Object.freeze({
    ...
    return Object.keys(hl).forEach((t => {
        const a = hl[t];
        a.install && e.use(a)
    })), e
}, gl = "1.0.0-beta1.0";
var fl = {version: "1.0.0-beta1.0", install: wl};
export {
    qa as BeAside,
    ga as BeAutocomplete,
    Ea as BeBreadcrumb,
    Ma as BeBreadcrumbItem,
    Pt as BeButton,
    ja as BeContainer,
    Oa as BeContextmenu,
    $a as BeContextmenuItem,
    Wt as BeDialog,
    ht as BeEllipsis,
    Xa as BeFooter,
    Za as BeHeader,
