/* * @register-account.vue * @deprecated * @author czh * @update (czh
2021/12/17) */
<template>
  <div class="flex flex-col items-start w-full">
    ...
    <div
      class="mb-2 h-24 border-b w-full flex items-center md:mb-4 lg:mb-4 sm:h-14"
    >
      ...
      <input
        ...
        type="text"
        class="login-input h-16 w-9/12 md:h-14 lg:h-14"
    ...
    >
      ...
      <input
        ...
        class="login-input flex-grow h-16 w-9/12 font-format md:h-14 lg:h-14"
        :type="isShowPassword"
    ...
    <div class="mb-8 flex w-full md:mb-4">
      ...
      >
        <img
          v-show="!emailSent && !sending"
          src="../../assets/img/send-vr-code.png"
          alt=""
        />
        <span v-show="sending" style="color: #606266">...</span>
        <span v-show="emailSent && !sending" style="color: #606266"
          >{{ sendSeconds }}s</span
        >
      </div>
    </div>
    <be-button
      ...
      @click="register"
    >
      <span class="font-format text-black">{{
