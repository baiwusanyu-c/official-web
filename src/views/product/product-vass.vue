...
<template>
    <div class="product-page" id="product_vass">
        ...
        <div class="page-head">
            <div class="header-text mr-1/2">
                ...
                <be-button customClass="try-out-btn h-btn-txt-black linear-l-r text-black text-xl"
                    ...
                    <span class="font-format">{{ $t('lang.tryoutBtn') }}</span>
                </be-button>
            </div>
        </div>
        <!--    文字介绍 & 走马灯   -->
        <div class="flex items-center justify-center bg-default text-center py-16 box-border w-full flex-col">
            <p class="product-desc text-lg font-format text-justify leading-normal"> {{ $t('lang.product.vass.desc') }}</p>
            <!--     走馬燈      -->
        ...
        <div class="func-container flex flex-col py-16 items-center justify-center bg-mainBlueGary box-border">
            ...
            <div class="flex w-full items-center justify-center">
                <div
                    ...
                    <p class="font-format text-center leading-normal"> {{ $t('lang.product.vass.funcDesc1') }}</p>
                </div>
                <div
                    class="func-card  bg-default flex flex-col items-center justify-start shadow-2xl mx-8 p-8 box-border rounded">
                    <h3 class="text-lg font-bold mb-8 text-center h-12 font-format">
                    ...
                    <p class="font-format text-center leading-normal"> {{ $t('lang.product.vass.funcDesc2') }}</p>
                </div>
                <div
                    class="func-card  bg-default flex flex-col items-center justify-start shadow-2xl mx-8 p-8 box-border rounded">
                    <h3 class="text-lg font-bold mb-8 text-center h-12 font-format">
                    ...
                    <p class="font-format text-center leading-normal"> {{ $t('lang.product.vass.funcDesc3') }}</p>
                </div>
                <div
                    class="func-card  bg-default flex flex-col items-center justify-start shadow-2xl mx-8 p-8 box-border rounded">
                    <h3 class="text-lg font-bold mb-8 text-center h-12 font-format">
                    ...
                    <p class="font-format text-center leading-normal"> {{ $t('lang.product.vass.funcDesc4') }}</p>
                </div>
            </div>
        ...
        <div class="advant-container flex  w-full py-16 flex-col justify-center relative px-20% md:px-40">
            ...
            <h2 class="text-4xl font-bold mb-12 text-default text-center font-format" style="z-index: 1">
