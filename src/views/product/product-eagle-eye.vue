    ...
    <div class="product-page" id="product_eagle">
        ...
        <div class="page-head">
            <div class="header-text mr-1/2">
                ...
                <img alt="" src="../../assets/img/eagle-logo.png" class="display-none w-36 h-36 mt-10 mx-auto sm:flex">
<!--                <be-button customClass="try-out-btn h-btn-txt-black linear-l-r text-black text-xl">{{$t('lang.tryoutBtn') }}</be-button>-->
        ...
        <div class="flex items-center justify-center bg-default text-center py-16 box-border w-full flex-col sm:py-8">
            <p class="product-desc text-lg font-format text-justify leading-normal sm:text-xs"> {{$t('lang.product.eagle.desc')}}</p>
            <!--     走馬燈      -->
        ...
        <div class="func-container flex flex-col py-16 items-center justify-center bg-mainBlueGary box-border sm:py-8">
            ...
            <div class="flex w-full items-center justify-center sm:flex-wrap">
                <div class="func-card  bg-default flex flex-col items-center justify-start shadow-2xl mx-8 p-8 box-border rounded sm:mx-2 sm:p-2">
                    ...
                    <p class="font-format text-center leading-normal sm:text-xs"> {{$t('lang.product.eagle.funcDesc1')}}</p>
                </div>
                <div class="func-card  bg-default flex flex-col items-center justify-start shadow-2xl mx-8 p-8 box-border rounded sm:mx-2 sm:p-2">
                    <h3 class="text-lg font-bold mb-8 text-center h-12 font-format sm:text-xs sm:mb-2"> {{$t('lang.product.eagle.funcSubTitle2')}}</h3>
                    <img class='mb-8 sm:mb-4' src="../../assets/img/eagle-func2.png" alt="">
                    <p class="font-format text-center leading-normal sm:text-xs"> {{$t('lang.product.eagle.funcDesc2')}}</p>
                </div>
                <div class="func-card  bg-default flex flex-col items-center justify-start shadow-2xl mx-8 p-8 box-border rounded sm:mx-2 sm:p-2 sm:mt-4">
                    <h3 class="text-lg font-bold mb-8 text-center h-12 font-format sm:text-xs sm:mb-4"> {{$t('lang.product.eagle.funcSubTitle3')}}</h3>
                    <img class='mb-8 sm:mb-4' src="../../assets/img/eagle-func3.png" alt="">
                    <p class="font-format text-center leading-normal sm:text-xs"> {{$t('lang.product.eagle.funcDesc3')}}</p>
                </div>
                <div class="func-card  bg-default flex flex-col items-center justify-start shadow-2xl mx-8 p-8 box-border rounded sm:mx-2 sm:p-2 sm:mt-4">
                    <h3 class="text-lg font-bold mb-8 text-center h-12 font-format sm:text-xs sm:mb-4"> {{$t('lang.product.eagle.funcSubTitle4')}}</h3>
                    <img class='mb-8 sm:mb-4' src="../../assets/img/eagle-func4.png" alt="">
                    <p class="font-format text-center leading-normal sm:text-xs"> {{$t('lang.product.eagle.funcDesc4')}}</p>
                </div>
            </div>

        </div>
        <!--    核心特色    -->
        <div class="advant-container flex w-full py-16 flex-col justify-center relative px-20% sm:px-4 sm:py-10">
            ...
            <h2 class="text-4xl font-bold mb-16 text-default text-center font-format sm:text-lg sm:mb-2" style="z-index: 1"> {{$t('lang.product.eagle.advantTitle')}}</h2>
        ...
        <!--    支持币种    -->
        <div class="support-c-container flex bg-mainBlueGary w-full py-32 px-80 flex-col justify-center items-center sm:py-10 sm:px-10">
            <h2 class="text-4xl font-bold mb-16 text-black text-center font-format sm:text-lg sm:mx-2 sm:mb-8"> {{$t('lang.product.eagle.supportTitle')}}</h2>
            <div class="flex justify-center sm:flex-wrap">
                <div class="rounded flex flex-col justify-center items-center bg-default w-52 pt-6 pb-4 mx-6 border-b hover:shadow-shadowG sm:w-20 sm:mx-2 sm:pt-0 sm:pb-0 sm:mb-8">
                    <div class="flex justify-center items-center mb-4 border-b w-full pb-6 sm:mb-0 sm:pb-2 sm:pt-2">
                ...
                <div class="rounded flex flex-col justify-center items-center bg-default w-52 pt-6 pb-4 mx-6 border-b hover:shadow-shadowG sm:w-20 sm:mx-2 sm:pt-0 sm:pb-0 ">
                    <div class="flex justify-center items-center mb-4 border-b w-full pb-6 sm:mb-0 sm:pb-2 sm:pt-2">
