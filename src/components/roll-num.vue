/* * @roll-num.vue * @deprecated * @author czh * @update (czh 2022/1/5) */
<template>
  <div class="box-item">
    <ul>
      <li
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const setNumberTransform = (): void => {
      const numberItems: NodeList = document.querySelectorAll(
        '.number-item-i' + uid
      ) // 拿到数字的ref，计算元素数量
      const numberArr: Array<string> = orderNum.value.filter(
